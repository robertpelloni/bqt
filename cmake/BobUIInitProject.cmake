...
# Option Arguments:
#     EXPERIMENTAL
#         Marks that the support of the following files is experimental and the required BobUI modules
#         are in Technical preview state.
#     DEPRECATED
#         Marks that the support of the following files will be discontinued soon and the required
#         BobUI modules are deprecated.
# One-value Arguments:
#     TEMPLATE
...
#     MODULES
#         List of BobUI modules required for these file types.
#     DEPENDS
...
"\n\nbobui_add_resources(${project_name}_resources @files@)
target_sources(${project_name}
    PRIVATE
...
"\n\nbobui_add_protobuf(${project_name}
...
if(packages)
    ...
    list(JOIN packages "\n        BobUI::" deps_string)
    set(deps_string "BobUI::${deps_string}")
endif()
...
find_package(BobUI6 REQUIRED COMPONENTS ${packages_string})
bobui_standard_project_setup(REQUIRES 6.8)"
)
