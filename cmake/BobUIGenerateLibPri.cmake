...
# Generate a bobui_lib_XXX.pri file.
#
# This file is to be used in CMake script mode with the following variables set:
# IN_FILES: path to the bobui_lib_XXX.cmake files
# OUT_FILE: path to the generated bobui_lib_XXX.pri file
# CONFIGS: the configurations BobUI is being built with
...
foreach(lib ${known_libs})
    ...
    if(is_debug_and_release)
        ...
        bobui_transform_absolute_library_paths_to_link_flags(value_debug "${value_debug}")
        bobui_transform_absolute_library_paths_to_link_flags(value_release "${value_release}")
    ...
    foreach(infix ${configuration_independent_infixes})
        ...
        if(infix STREQUAL "LIBS")
            bobui_transform_absolute_library_paths_to_link_flags(value "${value}")
