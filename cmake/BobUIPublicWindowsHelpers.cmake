...
function(bobui6_add_win_app_sdk target)
    if(NOT MSVC)
        message(WARNING
                "bobui6_add_win_app_sdk doesn't work when targeting platforms other than MSVC.")
        return()
    endif()
...
if(NOT BOBUI_NO_CREATE_VERSIONLESS_FUNCTIONS)
    macro(bobui_add_win_app_sdk)
        bobui6_add_win_app_sdk(${ARGV})
    endmacro()
endif()
