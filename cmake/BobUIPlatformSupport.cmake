...
if(BOBUI_QMAKE_TARGET_MKSPEC STREQUAL "wasm-emscripten-64")
    set(WASM64 1)
else()
    set(WASM64 0)
endif()
...
if(CMAKE_SIZEOF_VOID_P EQUAL 8)
    set(BOBUI_64BIT TRUE)
elseif(CMAKE_SIZEOF_VOID_P EQUAL 4)
    set(BOBUI_32BIT TRUE)
endif()

# Parses a version string like "xx.yy.zz" and sets the major, minor and patch variables.
function(bobui_parse_version_string version_string out_var_prefix)
...
# conditions like 'equals(BOBUI_GCC_MAJOR_VERSION,5)'.
if(CMAKE_CXX_COMPILER_VERSION)
    bobui_parse_version_string("${CMAKE_CXX_COMPILER_VERSION}" "BOBUI_COMPILER_VERSION")
endif()
