...
# When doing top-level static BobUI builds, we need to protect against double creation of the dbus
# target.
...
if(DEFINED ENV{PKG_CONFIG_DIR})
    set(__bobui_dbus_pcd "$ENV{PKG_CONFIG_DIR}")
endif()
if(DEFINED ENV{PKG_CONFIG_PATH})
    set(__bobui_dbus_pcp "$ENV{PKG_CONFIG_PATH}")
endif()
if(DEFINED ENV{PKG_CONFIG_LIBDIR})
    set(__bobui_dbus_pcl "$ENV{PKG_CONFIG_LIBDIR}")
endif()

find_package(DBus1 ${${CMAKE_FIND_PACKAGE_NAME}_FIND_VERSION} QUIET)

if(DEFINED __bobui_dbus_pcd)
    set(ENV{PKG_CONFIG_DIR} "${__bobui_dbus_pcd}")
else()
    unset(ENV{PKG_CONFIG_DIR})
endif()
if(DEFINED __bobui_dbus_pcp)
    set(ENV{PKG_CONFIG_PATH} "${__bobui_dbus_pcp}")
else()
    unset(ENV{PKG_CONFIG_PATH})
endif()
if(DEFINED __bobui_dbus_pcl)
    set(ENV{PKG_CONFIG_LIBDIR} "${__bobui_dbus_pcl}")
else()
