...
macro(_bobui_internal_sbom_find_python_and_dependency_helper_lambda)
    _bobui_internal_sbom_find_python_and_dependency_helper(
        PYTHON_ARGS
            ${extra_python_args}
            ${python_common_args}
        DEPENDENCY_ARGS
...
function(_bobui_internal_sbom_find_python_and_dependency_helper)
    set(opt_args)
    set(single_args
        OUT_VAR_PYTHON_PATH
    ...
    _bobui_internal_sbom_find_python_helper(
        ${arg_PYTHON_ARGS}
    ...
    if(python_found_inner AND python_path_inner)
        _bobui_internal_sbom_find_python_dependency_helper(
            ${arg_DEPENDENCY_ARGS}
...
# Tries to find the python intrepreter, given the BOBUI_SBOM_PYTHON_INTERP path hint, as well as
# other options.
...
# different purpose (e.g. bobuiwebengine or bobuiinterfaceframework).
...
function(_bobui_internal_sbom_find_python_helper)
    set(opt_args
    ...
    if(BOBUI_SBOM_PYTHON_INTERP)
        set(Python3_ROOT_DIR ${BOBUI_SBOM_PYTHON_INTERP})
    endif()
...
function(_bobui_internal_sbom_find_python_dependency_helper)
    set(opt_args "")
    set(single_args
...
function(_bobui_internal_sbom_find_python_dependency_program)
    set(opt_args
        REQUIRED
    )
    set(single_args
    ...
    set(cache_var "BOBUI_SBOM_PROGRAM_${upper_name}")
    ...
    if(BOBUI_SBOM_PYTHON_APPS_PATH)
        list(APPEND hints ${BOBUI_SBOM_PYTHON_APPS_PATH})
    endif()
    ...
    if(BOBUI_SBOM_PYTHON_INTERP)
        list(APPEND hints ${BOBUI_SBOM_PYTHON_INTERP})
    endif()
