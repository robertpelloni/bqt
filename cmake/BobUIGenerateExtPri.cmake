...
# Generate a bobui_ext_XXX.pri file.
#
# - Replaces occurrences of the build libdir with $$[BOBUI_INSTALL_LIBDIR/get].
#
# This file is to be used in CMake script mode with the following variables set:
# IN_FILES: path to the bobui_ext_XXX.cmake files
# OUT_FILE: path to the generated bobui_ext_XXX.pri file
# BOBUI_BUILD_LIBDIR: path to BobUI's libdir when building (those paths get replaced)
set(content "")
...
")
    ...
    set(fixed_libs "")
    foreach(lib ${libs})
        string(REPLACE "${BOBUI_BUILD_LIBDIR}" "$$[BOBUI_INSTALL_LIBS/get]" lib "${lib}")
