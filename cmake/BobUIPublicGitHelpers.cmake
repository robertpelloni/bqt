...
function(_bobui_internal_query_git_version)
    set(opt_args
    ...
    if(BOBUI_SBOM_FAKE_GIT_VERSION)
        ...
        set(git_version "${version_git_head}+${version_git_branch}")
        _bobui_internal_set_git_query_variables()
        return()
    endif()
    ...
    get_cmake_property(git_hash_cache _bobui_git_hash_cache_${working_directory})
    get_cmake_property(git_hash_short_cache _bobui_git_hash_short_cache_${working_directory})
    get_cmake_property(git_version_cache _bobui_git_version_cache_${working_directory})
    get_cmake_property(git_version_path_cache _bobui_git_version_path_cache_${working_directory})
    if(git_hash_cache)
    ...
    set_property(GLOBAL PROPERTY _bobui_git_hash_cache_${working_directory} "${git_hash}")
    set_property(GLOBAL PROPERTY _bobui_git_hash_short_cache_${working_directory} "${git_hash_short}")
    set_property(GLOBAL PROPERTY _bobui_git_version_cache_${working_directory} "${git_version}")
    set_property(GLOBAL PROPERTY _bobui_git_version_path_cache_${working_directory}
        "${git_version_path}")
