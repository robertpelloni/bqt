...
# execute_process.
function(_bobui_internal_create_command_script)
    ...
    if(NOT arg_COMMAND)
        message(FATAL_ERROR "bobui_internal_create_command_script: COMMAND is not specified")
    endif()

    if(NOT arg_OUTPUT_FILE)
        message(FATAL_ERROR "bobui_internal_create_command_script: Wrapper OUTPUT_FILE\
is not specified")
    endif()
...
"#!${CMAKE_COMMAND} -P
# BobUI generated command wrapper
...
function(_bobui_internal_test_batch_target_name out)
...
function(_bobui_internal_make_check_target testname)
    set(options "")
