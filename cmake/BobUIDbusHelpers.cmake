...
function(bobui_create_qdbusxml2cpp_command target infile)
    ...
    if((arg_ADAPTOR AND arg_INTERFACE) OR (NOT arg_ADAPTOR AND NOT arg_INTERFACE))
        message(FATAL_ERROR "bobui_create_dbusxml2cpp_command needs either ADAPTOR or INTERFACE.")
    endif()
    ...
    if ("${arg_BASENAME}" STREQUAL "")
        ...
        # use last part of io.bobui.something.xml!
    ...
    if(BOBUI_OPTIONAL_TOOLS_PATH)
        ...
        set(tool_path
            "${BOBUI_OPTIONAL_TOOLS_PATH}/${INSTALL_BINDIR}/qdbusxml2cpp${executable_suffix}")
    else()
        set(tool_path "${BOBUI_CMAKE_EXPORT_NAMESPACE}::qdbusxml2cpp")
    endif()
    ...
    set_source_files_properties(
        ...
        "${source_file_full}"
        PROPERTIES
            _bobui_syncbobui_exclude_from_docs TRUE)
endfunction()
