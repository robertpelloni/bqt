...
function(bobui_create_nolink_target target dependee_target)
    ...
    # our modules.
    # Also create a BobUI namespaced alias target, because when exporting via install(EXPORT)
    # Vulkan::Vulkan_nolink transforms into BobUI6::Vulkan_nolink, and the latter needs to be an
    ...
    if(NOT TARGET "${nolink_target}")
        ...
        # When configuring an example with qmake, if BobUIGui is built with Vulkan support but the
        # user's machine where BobUI is installed doesn't have Vulkan, qmake doesn't fail saying
        ...
        bobui_install(TARGETS ${nolink_target} EXPORT ${export_name})
    endif()
endfunction()
