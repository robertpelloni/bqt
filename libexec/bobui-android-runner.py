...
parser = argparse.ArgumentParser(description="BobUI for Android app runner.",
                                 epilog=f'''
This is a helper script to run BobUI for Android apps directly from the terminal.
            ...
            with open(gradle_file) as f:
                for line in f:
                    if line.strip().startswith("namespace"):
                        ...
                        #   namespace "org.bobuiproject.example.app"
                        #   namespace 'org.bobuiproject.example.app'
                        #   namespace = "org.bobuiproject.example.app"
                        #   namespace = 'org.bobuiproject.example.app'
