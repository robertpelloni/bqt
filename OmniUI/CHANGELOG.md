...
## [v42.1.0] - The Omni Crisis (Phase 2 Integration)
...
*   **Master Clock Porting**: Successfully ported `OmniAGI` (Singularity), `OmniSimulationLoop` (Genesis), `OmniAbyss` (Void), and `OmniEtherealPlane` (Spirit) off of isolated internal QTimers. They now exclusively listen to `OmniSimulationEngine::instance()->globalTick(dt)`, meaning altering time dilation scales their physics natively.
