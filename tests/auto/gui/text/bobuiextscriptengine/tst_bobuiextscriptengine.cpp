...
class tst_BOBUIextScriptEngine : public QObject
{
    Q_OBJECT

public:
    tst_BOBUIextScriptEngine();
...
private slots:
    ...
    void controlInSyllable_bobuibug14204();
    void combiningMarks_bobuibug15675_data();
    void combiningMarks_bobuibug15675();
...
tst_BOBUIextScriptEngine::tst_BOBUIextScriptEngine()
    : haveTestFonts(qgetenv("BOBUI_HAVE_TEST_FONTS") == QByteArray("1"))
{
}

void tst_BOBUIextScriptEngine::initTestCase()
{
    if (!haveTestFonts) {
        qWarning(
            ...
            "If you have the fonts available, set BOBUI_HAVE_TEST_FONTS=1 in your environment and "
            "run the test again."
        );
    }
}
...
static void prepareShapingTest(const QFont &font, const ShapeTable *shape_table)
{
    for (const ShapeTable *s = shape_table; s->unicode[0]; ++s) {
        ...
        BOBUIest::newRow(testName.constData()) << font << string << glyphs;
    }
}
...
static void doShapingTests()
{
    ...
    BOBUIextLayout layout(string, font);
    BOBUIextEngine *e = layout.engine();
    e->itemize();
    e->shape(0);
    ...
    if (!glyphs.isEmpty()) {
        ...
        BOBUIextLayout decomposedLayout(string.normalized(QString::NormalizationForm_D), font);
        BOBUIextEngine *de = decomposedLayout.engine();
        de->itemize();
        de->shape(0);
...
void tst_BOBUIextScriptEngine::devanagari_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...
void tst_BOBUIextScriptEngine::devanagari()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::bengali_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...
void tst_BOBUIextScriptEngine::bengali()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::gurmukhi_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...
void tst_BOBUIextScriptEngine::gurmukhi()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::oriya_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...
void tst_BOBUIextScriptEngine::oriya()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::tamil_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...
void tst_BOBUIextScriptEngine::tamil()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::telugu_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...
void tst_BOBUIextScriptEngine::telugu()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::kannada_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...
void tst_BOBUIextScriptEngine::kannada()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::malayalam_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...
void tst_BOBUIextScriptEngine::malayalam()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::sinhala_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...
void tst_BOBUIextScriptEngine::sinhala()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::khmer_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...
void tst_BOBUIextScriptEngine::khmer()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::linearB_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...
void tst_BOBUIextScriptEngine::linearB()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::greek_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    BOBUIest::addColumn<QList<ushort>>("glyphs");
...

    {
        if (QFontDatabase::families(QFontDatabase::Any).contains("DejaVu Sans")) {
            ...
            for (int uc = 0x1f00; uc <= 0x1fff; ++uc) {
                ...
                BOBUIest::newRow(testName.constData()) << f << string << QList<ushort>();
            }
        } else
...
void tst_BOBUIextScriptEngine::greek()
{
    doShapingTests();
}

void tst_BOBUIextScriptEngine::mirroredChars_data()
{
    BOBUIest::addColumn<QString>("s");

    BOBUIest::newRow("()") << QStringLiteral("()");
    BOBUIest::newRow("[]") << QStringLiteral("[]");
    BOBUIest::newRow("{}") << QStringLiteral("{}");
}

void tst_BOBUIextScriptEngine::mirroredChars()
{
    QFETCH(QString, s);
...
void tst_BOBUIextScriptEngine::controlInSyllable_bobuibug14204()
{
...
void tst_BOBUIextScriptEngine::combiningMarks_bobuibug15675_data()
{
    BOBUIest::addColumn<QFont>("font");
    BOBUIest::addColumn<QString>("string");
    ...
    for (const QString &family : families) {
        ...
        for (ushort uc = 0x0300; uc < 0x0370; ++uc) {
            ...
            BOBUIest::newRow(testName.constData()) << font << s;
        }
    }
...
void tst_BOBUIextScriptEngine::combiningMarks_bobuibug15675()
{
    QFETCH(QFont, font);
    QFETCH(QString, string);
...
void tst_BOBUIextScriptEngine::thaiIsolatedSaraAm()
{
...
void tst_BOBUIextScriptEngine::thaiWithZWJ()
{
#if BOBUI_CONFIG(system_harfbuzz)
...
void tst_BOBUIextScriptEngine::thaiMultipleVowels()
{
...
void tst_BOBUIextScriptEngine::shapingDisabledLatin()
{
    QString s("fi");
...
void tst_BOBUIextScriptEngine::shapingDisabledDevanagari()
{
    QString s;
    s += QChar(0x0915); // KA
...
BOBUIEST_MAIN(tst_BOBUIextScriptEngine)
#include "tst_bobuiextscriptengine.moc"
