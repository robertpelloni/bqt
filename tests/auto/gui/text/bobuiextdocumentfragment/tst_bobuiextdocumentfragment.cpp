...
class tst_BOBUIextDocumentFragment : public QObject
{
    Q_OBJECT

public:
    tst_BOBUIextDocumentFragment();
    ~tst_BOBUIextDocumentFragment();
...
private slots:
    ...
    void html_bobui3Whitespace();
    void html_bobui3WhitespaceWithFragments();
    void html_bobui3WhitespaceAfterTags();
    ...
    void html_bobui3RichtextWhitespaceMode();
    void html_brAfterHr();
...
private:
    ...
    // don't take the shortcut in BOBUIextDocument::setHtml
    { doc->clear(); BOBUIextCursor(doc).insertFragment(BOBUIextDocumentFragment::fromHtml(html)); }
...
tst_BOBUIextDocumentFragment::tst_BOBUIextDocumentFragment()
{
...
void tst_BOBUIextDocumentFragment::init()
{
    doc = new BOBUIextDocument;
    cursor = BOBUIextCursor(doc);
}

void tst_BOBUIextDocumentFragment::cleanup()
{
...
void tst_BOBUIextDocumentFragment::listCopying()
{
    cursor.insertList(BOBUIextListFormat::ListDecimal);

    BOBUIextFormat originalBlockFormat = cursor.blockFormat();
...
void tst_BOBUIextDocumentFragment::listZeroCopying()
{
...
void tst_BOBUIextDocumentFragment::listCopying2()
{
    cursor.insertList(BOBUIextListFormat::ListDecimal);
    cursor.insertText("Hello World");

    cursor.insertList(BOBUIextListFormat::ListDisc);
    cursor.insertText("Hello World");
    ...
    do {
        if (cursor.currentList())
            listItemCount++;
    } while (cursor.movePosition(BOBUIextCursor::NextBlock));
...
void tst_BOBUIextDocumentFragment::tableCopying()
{
    ...
    BOBUIextDocumentFragment fragment;
    {
        ...
        fragment = BOBUIextDocumentFragment(&doc);
    }
    {
        BOBUIextDocument doc;
        BOBUIextCursor cursor(&doc);
...
void tst_BOBUIextDocumentFragment::tableCopyingWithColSpans()
{
    const char html[] = ""
"<table border>"
"  <tr>"
...
"</table>";
    ...
    cursor.setPosition(table->cellAt(0, 0).firstPosition(), BOBUIextCursor::KeepAnchor);
    ...
    BOBUIextDocumentFragment frag = cursor.selection();
    cleanup();
    init();
...
void tst_BOBUIextDocumentFragment::tableColSpanAndWidth()
{
    const char html[] = ""
"<table border=\"0\">"
"  <tr>"
...
void tst_BOBUIextDocumentFragment::tableImport()
{
    // used to cause a failing assertion, as HTMLImporter::closeTag was
    // called twice with the last node.
    BOBUIextDocumentFragment fragment = BOBUIextDocumentFragment::fromHtml(QString::fromLatin1("<table><tr><td>Hey</td><td>Blah"));
    QVERIFY(!fragment.isEmpty());
}

void tst_BOBUIextDocumentFragment::tableImport2()
{
    {
        const char html[] = ""
            "<table>"
        ...
        BOBUIextDocument doc;
        BOBUIextCursor cursor(&doc);
        cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(QByteArray::fromRawData(html, sizeof(html) / sizeof(html[0]))));
    ...
    }
    {
        ...
        /*
        BOBUIextCursor fourthCell = table->cellAt(1, 1).firstCursorPosition();
        fourthCell.movePosition(BOBUIextCursor::NextBlock);
    ...
    }
    {
        ...
        BOBUIextDocument doc;
        BOBUIextCursor cursor(&doc);
        cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(QByteArray::fromRawData(buggyHtml, sizeof(buggyHtml) / sizeof(buggyHtml[0]))));
...
void tst_BOBUIextDocumentFragment::tableImport3()
{
    // ### would be better to have tree tests for BOBUIextHtmlParser
    ...
    BOBUIextDocumentFragment fragment = BOBUIextDocumentFragment::fromHtml(QString::fromLatin1(html));
    QVERIFY(!fragment.isEmpty());
}

void tst_BOBUIextDocumentFragment::tableImport4()
{
    const char html[] = "<table>"
        "<tr><td>blah</td></tr>"
        "<tr><td>blah</td><td>blah</td></tr>"
        "</table>";
    cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(QString::fromLatin1(html)));
    cursor.movePosition(BOBUIextCursor::Start);
    cursor.movePosition(BOBUIextCursor::NextBlock);
...
void tst_BOBUIextDocumentFragment::tableImport5()
{
    const char html[] = "<table>"
        "<tr>"
        " <td>Foo</td>"
...
void tst_BOBUIextDocumentFragment::textCopy()
{
    /* this test used to cause failing assertions in BOBUIextDocumentFragment */
    /* copy&paste 'lo\bwor' */
    ...
    cursor.movePosition(BOBUIextCursor::Start);
    cursor.movePosition(BOBUIextCursor::NextCharacter, BOBUIextCursor::MoveAnchor, 3);
    cursor.movePosition(BOBUIextCursor::NextBlock, BOBUIextCursor::KeepAnchor);
    cursor.movePosition(BOBUIextCursor::NextCharacter, BOBUIextCursor::KeepAnchor, 3);
...
void tst_BOBUIextDocumentFragment::copyWholeDocument()
{
    ...
    QVERIFY(doc->rootFrame()->frameFormat().background().color() == BobUI::red);
}

void tst_BOBUIextDocumentFragment::title()
{
    doc->setHtml(QString::fromLatin1("<html><head><title>Test</title></head><body>Blah</body></html>"));
    QCOMPARE(doc->metaInformation(BOBUIextDocument::DocumentTitle), QString::fromLatin1("Test"));
}

void tst_BOBUIextDocumentFragment::html_listIndents1()
{
...
void tst_BOBUIextDocumentFragment::html_listIndents2()
{
...
void tst_BOBUIextDocumentFragment::html_listIndents3()
{
...
void tst_BOBUIextDocumentFragment::html_listIndents4()
{
...
void tst_BOBUIextDocumentFragment::html_listIndents5()
{
...
void tst_BOBUIextDocumentFragment::html_listIndents6()
{
...
void tst_BOBUIextDocumentFragment::html_listIndents7()
{
    const char html[] = "<ul><li style=\"-bobui-block-indent:1;\">Hey</ul>";
    setHtml(QString::fromLatin1(html));
    cursor.movePosition(BOBUIextCursor::Start);
    cursor.movePosition(BOBUIextCursor::NextBlock);
    BOBUIextList *list = cursor.currentList();
...
void tst_BOBUIextDocumentFragment::blockCharFormat()
{
...
void tst_BOBUIextDocumentFragment::blockCharFormatCopied()
{
    BOBUIextCharFormat fmt;
    fmt.setForeground(BobUI::green);
    cursor.setBlockCharFormat(fmt);
    cursor.insertText("Test", BOBUIextCharFormat());
    BOBUIextDocumentFragment frag(doc);
    cleanup();
    init();
    cursor.insertFragment(frag);
...
void tst_BOBUIextDocumentFragment::initialBlock()
{
...
void tst_BOBUIextDocumentFragment::clone()
{
    BOBUIextBlockFormat mod;
    mod.setAlignment(BobUI::AlignCenter);
    cursor.mergeBlockFormat(mod);
    cursor.insertText("Blah");
    QCOMPARE(cursor.blockFormat().alignment(), BobUI::AlignCenter);
    BOBUIextDocumentFragment frag(doc);
    cleanup();
    init();
    cursor.insertFragment(frag);
...
void tst_BOBUIextDocumentFragment::dontRemoveInitialBlockIfItHoldsObjectIndexedCharFormat()
{
...
void tst_BOBUIextDocumentFragment::dosLineFeed()
{
...
void tst_BOBUIextDocumentFragment::unorderedListEnumeration()
{
    const char html[] = "<ul><ul><ul><li>Blah</li></ul></ul>";
    setHtml(QString::fromLatin1(html));
    cursor.movePosition(BOBUIextCursor::End);
    QVERIFY(cursor.currentList());
    QCOMPARE(cursor.currentList()->format().style(), BOBUIextListFormat::ListDisc);

    const char html2[] = "<ul><ul><ul type=circle><li>Blah</li></ul></ul>";
    setHtml(QString::fromLatin1(html2));
    cursor.movePosition(BOBUIextCursor::End);
    QVERIFY(cursor.currentList());
    QCOMPARE(cursor.currentList()->format().style(), BOBUIextListFormat::ListCircle);

}

void tst_BOBUIextDocumentFragment::resetHasBlockAfterClosedBlockTags()
{
...
void tst_BOBUIextDocumentFragment::ignoreStyleTags()
{
...
void tst_BOBUIextDocumentFragment::hrefAnchor()
{
    {
...
void tst_BOBUIextDocumentFragment::namedAnchorFragments()
{
    ...
    BOBUIextBlock::Iterator it = firstBlock.begin();
    QVERIFY(!it.atEnd());
...
void tst_BOBUIextDocumentFragment::namedAnchorFragments2()
{
    ...
    BOBUIextBlock::Iterator it = doc->begin().begin();
    QVERIFY(!it.atEnd());
...
void tst_BOBUIextDocumentFragment::namedAnchorFragments3()
{
...
void tst_BOBUIextDocumentFragment::dontInheritAlignmentInTables()
{
    ...
    QVERIFY(cursor.currentTable()->cellAt(0, 0).firstCursorPosition().block().next().blockFormat().alignment() != BobUI::AlignHCenter);
}

void tst_BOBUIextDocumentFragment::cellBlockCount()
{
    ...
    BOBUIextTableCell cell = cursor.currentTable()->cellAt(0, 0);
    QVERIFY(cell.isValid());

    int blockCount = 0;
    for (BOBUIextFrame::iterator it = cell.begin(); !it.atEnd(); ++it) {
...
void tst_BOBUIextDocumentFragment::cellBlockCount2()
{
...
void tst_BOBUIextDocumentFragment::emptyTable()
{
...
void tst_BOBUIextDocumentFragment::emptyTable2()
{
...
void tst_BOBUIextDocumentFragment::emptyTable3()
{
    ...
    BOBUIextCursor cursor = cell.firstCursorPosition();
    cursor.setPosition(cell.lastPosition(), BOBUIextCursor::KeepAnchor);
    QCOMPARE(cursor.selectedText(), QString("Foobar"));
}

void tst_BOBUIextDocumentFragment::doubleRowClose()
{
...
void tst_BOBUIextDocumentFragment::mayNotHaveChildren()
{
...
void tst_BOBUIextDocumentFragment::inheritAlignment()
{
    // make sure attributes from the body tag get inherited
    const char html[] = "<body align=right><p>Hey";
    setHtml(QString::fromLatin1(html));
    // html alignment is absolute
    QCOMPARE(doc->begin().blockFormat().alignment(), BobUI::Alignment(BobUI::AlignRight|BobUI::AlignAbsolute));
}

void tst_BOBUIextDocumentFragment::dontEmitEmptyNodeWhenEmptyTagIsFollowedByCloseTag()
{
    // make sure the Hey does not end up as tag text for the img tag
    const char html[] = "<body align=right><p align=left>Blah<img></img><p>Hey";
    setHtml(QString::fromLatin1(html));
    QCOMPARE(doc->begin().blockFormat().alignment(), BobUI::Alignment(BobUI::AlignLeft|BobUI::AlignAbsolute));
    QCOMPARE(doc->begin().next().blockFormat().alignment(), BobUI::Alignment(BobUI::AlignRight|BobUI::AlignAbsolute));
}

void tst_BOBUIextDocumentFragment::toPlainText()
{
    QString input = "Hello\nWorld";
...
void tst_BOBUIextDocumentFragment::toRawText()
{
    // Make sure nbsp, line separator, paragraph separator is preserved
    doc->setPlainText("Hello\u0A00\u2028\u2029World");

    QCOMPARE(BOBUIextDocumentFragment(doc).toRawText(), "Hello\u0A00\u2028\u2029World");
}

void tst_BOBUIextDocumentFragment::copyTableRow()
{
    BOBUIextDocumentFragment frag;
    {
        ...
        frag = BOBUIextDocumentFragment(cursor);
    }
    {
        BOBUIextDocument doc2;
        cursor = BOBUIextCursor(&doc2);
        cursor.insertFragment(frag);
...
void tst_BOBUIextDocumentFragment::copyTableColumn()
{
    BOBUIextDocumentFragment frag;
    {
        BOBUIextTable *table = cursor.insertTable(2, 2);
        ...
        cursor.movePosition(BOBUIextCursor::Down, BOBUIextCursor::KeepAnchor);
...
void tst_BOBUIextDocumentFragment::copySubTable()
{
    BOBUIextDocumentFragment frag;
    {
        BOBUIextTableFormat fmt;
        ...
        BOBUIextTable *table = cursor.insertTable(4, 4, fmt);
...
void tst_BOBUIextDocumentFragment::html_textDecoration()
{
...
void tst_BOBUIextDocumentFragment::html_infiniteLoop()
{
    {
        // used to cause an infinite loop due to the lack of a space after the
        // tag name
        const char html[] = "<ahref=\"argl\">Link</a>";
        cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(html));
        QVERIFY(true);
    }
...
void tst_BOBUIextDocumentFragment::html_blockIndent()
{
    const char html[] = "<p style=\"-bobui-block-indent:3;\">Test</p>";
    cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(html));
    QCOMPARE(cursor.blockFormat().indent(), 3);
}

void tst_BOBUIextDocumentFragment::html_listIndent()
{
    const char html[] = "<ul style=\"-bobui-list-indent:4;\"><li>Blah</ul>";
    cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(html));
    QVERIFY(cursor.currentList());
    QCOMPARE(cursor.currentList()->format().indent(), 4);
}

void tst_BOBUIextDocumentFragment::html_listNestedParagraphIndent()
{
    const char html[] = "<ul style=\"-bobui-list-indent:2;\"><li>Blah<p>exposition</p></li></ul>";
    cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(html));
...
void tst_BOBUIextDocumentFragment::html_whitespace_data()
{
    BOBUIest::addColumn<QString>("html");
    BOBUIest::addColumn<QString>("expectedPlainText");

    BOBUIest::newRow("1") << QString("<span>This is some test</span><span> with spaces between words</span>")
                       << QString("This is some test with spaces between words");

    BOBUIest::newRow("2") << QString("<span>  </span><span>nowhitespacehereplease</span>")
                       << QString::fromLatin1("nowhitespacehereplease");

    BOBUIest::newRow("3") << QString("<span style=\"white-space: pre;\">  white  space  \n\n  here  </span>")
                       << QString::fromLatin1("  white  space  \n\n  here  ");

    BOBUIest::newRow("4") << QString("<span style=\"white-space: pre-wrap;\">  white  space  \n\n  here  </span>")
                       << QString::fromLatin1("  white  space  \n\n  here  ");

    BOBUIest::newRow("5") << QString("<a href=\"One.html\">One</a> <a href=\"Two.html\">Two</a> <b>Three</b>\n"
                                  "<b>Four</b>")
                       << QString::fromLatin1("One Two Three Four");

    BOBUIest::newRow("6") << QString("<p>Testing:     <b><i><u>BoldItalic</u></i></b> <i>Italic</i></p>")
                       << QString("Testing: BoldItalic Italic");

    BOBUIest::newRow("7") << QString("<table><tr><td>Blah</td></tr></table> <table border><tr><td>Foo</td></tr></table>")
                       << QString("\nBlah\n\nFoo\n");

    BOBUIest::newRow("8") << QString("<table><tr><td><i>Blah</i></td></tr></table> <i>Blub</i>")
                       << QString("\nBlah\nBlub");

    BOBUIest::newRow("9") << QString("<span style=\"white-space: nowrap;\">  white  space  \n\n  here  </span>")
                       << QString::fromLatin1("white space here ");

    BOBUIest::newRow("10") << QString("<span style=\"white-space: pre-line;\">  white  space  \n\n  here  </span>")
                        << QString::fromLatin1("white space\n\nhere ");

    BOBUIest::newRow("task116492") << QString("<p>a<font=\"Times\"> b </font>c</p>")
                                << QString("a b c");

    BOBUIest::newRow("task121653") << QString("abc<b> def</b>")
                                << QString("abc def");

    BOBUIest::newRow("task122650") << QString("<p>Foo</p>    Bar")
                                << QString("Foo\nBar");

    BOBUIest::newRow("task122650-2") << QString("<p>Foo</p>  <p>  Bar")
                                  << QString("Foo \nBar");

    BOBUIest::newRow("task122650-3") << QString("<html>Before<pre>\nTest</pre>")
                                  << QString("Before\nTest");

    BOBUIest::newRow("br-with-whitespace") << QString("Foo<br>\nBlah")
                                        << QString("Foo\nBlah");

    BOBUIest::newRow("collapse-p-with-newline") << QString("Foo<p>\n<p>\n<p>\n<p>\n<p>\n<p>\nBar")
            << QString("Foo\nBar");

    BOBUIest::newRow("table") << QString("<table><tr><td>Blah</td></tr></table>\nTest")
                           << QString("\nBlah\nTest");

    BOBUIest::newRow("table2") << QString("<table><tr><td><pre>\nTest\n</pre></td>\n </tr></table>")
                            << QString("\nTest\n");

    BOBUIest::newRow("table3") << QString("<table><tr><td><pre>\nTest\n</pre> \n \n </td></tr></table>")
                            << QString("\nTest \n");
}

void tst_BOBUIextDocumentFragment::html_whitespace()
{
    QFETCH(QString, html);
...
void tst_BOBUIextDocumentFragment::html_bobui3Whitespace()
{
...
void tst_BOBUIextDocumentFragment::html_bobui3WhitespaceWithFragments()
{
    QString text = "This     text       has         some   whitespace"
                   "\n and \nnewlines that \n should be ignored\n\n";
    const QString html = QString("<html><head><meta name=\"qrichtext\" content=\"1\" /></head><body>"
...
void tst_BOBUIextDocumentFragment::html_bobui3WhitespaceAfterTags()
{
    QString text = "    This     text       has         some   whitespace   ";
...
void tst_BOBUIextDocumentFragment::html_listStart1()
{
...
void tst_BOBUIextDocumentFragment::html_listStart2()
{
...
void tst_BOBUIextDocumentFragment::html_cssMargin()
{
    const char html[] = "<p style=\"margin-top: 1px; margin-bottom: 2px; margin-left: 3px; margin-right: 4px\">Test</p>";
    cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(html));
    const BOBUIextBlockFormat fmt = cursor.blockFormat();
...
void tst_BOBUIextDocumentFragment::html_hexEntities()
{
    const char html[] = "&#x00040;";
    cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(html));
...
void tst_BOBUIextDocumentFragment::html_decEntities()
{
    const char html[] = "&#64;";
    cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(html));
    QCOMPARE(doc->begin().begin().fragment().text(), QString("@"));
...
void tst_BOBUIextDocumentFragment::html_thCentered()
{
    ...
    QVERIFY(table->cellAt(0, 0).begin().currentBlock().blockFormat().alignment() == BobUI::AlignCenter);
}

void tst_BOBUIextDocumentFragment::orderedListNumbering()
{
...
void tst_BOBUIextDocumentFragment::html_blockAfterList()
{
...
void tst_BOBUIextDocumentFragment::html_listStartAttribute()
{
...
void tst_BOBUIextDocumentFragment::html_subAndSuperScript()
{
    ...
    setHtml(subHtml);
    QCOMPARE(cursor.charFormat().verticalAlignment(), BOBUIextCharFormat::AlignSubScript);

    setHtml(subHtmlCss);
    QCOMPARE(cursor.charFormat().verticalAlignment(), BOBUIextCharFormat::AlignSubScript);

    setHtml(superHtml);
    QCOMPARE(cursor.charFormat().verticalAlignment(), BOBUIextCharFormat::AlignSuperScript);
...
void tst_BOBUIextDocumentFragment::html_cssColors()
{
    const char color[] = "<span style=\"color:red\"><span style=\"color:blue\">Blue</span></span>";
    setHtml(color);
    QVERIFY(cursor.charFormat().foreground().color() == BobUI::blue);
...
void tst_BOBUIextDocumentFragment::obeyFragmentMarkersInImport()
{
...
void tst_BOBUIextDocumentFragment::whitespaceWithFragmentMarkers()
{
...
void tst_BOBUIextDocumentFragment::html_emptyParapgraphs1()
{
    const char html[] = "<p style=\"-bobui-paragraph-type:empty;\">&nbsp;</p><p>Two paragraphs</p>";
    setHtml(html);
...
void tst_BOBUIextDocumentFragment::html_emptyParapgraphs2()
{
...
void tst_BOBUIextDocumentFragment::html_emptyParagraphs3()
{
...
void tst_BOBUIextDocumentFragment::html_emptyParagraphs4()
{
    ...
    block = block.next();
    QVERIFY(block.isValid());
    BOBUIextBlockFormat bf = block.blockFormat();
    QVERIFY(bf.hasProperty(BOBUIextFormat::PageBreakPolicy));
    QCOMPARE(bf.pageBreakPolicy(), BOBUIextFormat::PageBreak_AlwaysBefore);
    ...
    QVERIFY(bf.hasProperty(BOBUIextFormat::PageBreakPolicy));
    QCOMPARE(bf.pageBreakPolicy(), BOBUIextFormat::PageBreak_AlwaysBefore); // after the empty line means it should appear for 'bar'
    QCOMPARE(block.text(), QString("bar"));
}

void tst_BOBUIextDocumentFragment::html_font()
{
    const char html[] = "<font color=\"blue\"><p>Hah</p></font>";
    setHtml(html);

    QVERIFY(cursor.charFormat().foreground().color() == BobUI::blue);
    QVERIFY(cursor.blockCharFormat().foreground().color() == BobUI::blue);
}

void tst_BOBUIextDocumentFragment::html_fontSize()
{
    const char html[] = "<font size=\"2\">Hah</font>";
    setHtml(html);

    QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontSizeAdjustment).toInt(), -1);
}

void tst_BOBUIextDocumentFragment::html_fontSizeAdjustment()
{
    const char html[] = "<font size=\"7\"><b>Hah</b></font>";
    setHtml(html);

    QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontSizeAdjustment).toInt(), 4);
    QCOMPARE(cursor.charFormat().fontWeight(), int(QFont::Bold));
}

void tst_BOBUIextDocumentFragment::html_cssFontSize()
{
    const char html[] = "<span style=\"font-size: 50pt\">Foo</span>";
    setHtml(html);

    QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontPointSize).toInt(), 50);

    const char html2[] = "<span style=\"font-size: 50px\">Foo</span>";
    setHtml(html2);

    QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontPixelSize).toInt(), 50);
...
void tst_BOBUIextDocumentFragment::html_cssShorthandFont()
{
    {
        const char html[] = "<span style=\"font: 50px sans-serif\">Foo</span>";
        setHtml(html);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontPixelSize).toInt(), 50);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontFamilies).toStringList(),
    ...
    }
    {
        ...
        setHtml(html);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontPointSize).toInt(), 7);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontFamilies).toStringList(),
    ...
    }
    {
        ...
        setHtml(html);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontWeight).toInt(), int(QFont::Bold));
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontPointSize).toInt(), 7);
    }
    {
        ...
        setHtml(html);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontWeight).toInt(), int(QFont::Bold));
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontItalic).toBool(), true);
    }
}

void tst_BOBUIextDocumentFragment::html_bodyBgColor()
{
    const char html[] = "<body bgcolor=\"blue\">Foo</body>";
    doc->setHtml(html);

    QVERIFY(doc->rootFrame()->frameFormat().background().color() == BobUI::blue);
}

void tst_BOBUIextDocumentFragment::html_bobuiBgColor()
{
    const char html[] = "<bobui bgcolor=\"blue\">Foo</bobui>";
    doc->setHtml(html);

    QVERIFY(doc->rootFrame()->frameFormat().background().color() == BobUI::blue);
}

void tst_BOBUIextDocumentFragment::html_bodyBackground()
{
    const char html[] = "<body background=\"foo.png\">Foo</body>";
    doc->setHtml(html);

    QCOMPARE(doc->rootFrame()->frameFormat().background().style(), BobUI::TexturePattern);
}

void tst_BOBUIextDocumentFragment::html_tableCellBackground()
{
    ...
    BOBUIextTableCell cell = table->cellAt(0, 0);
    QCOMPARE(cell.format().background().style(), BobUI::TexturePattern);
}

void tst_BOBUIextDocumentFragment::css_bodyBackground()
{
...
void tst_BOBUIextDocumentFragment::css_tableCellBackground()
{
...
void tst_BOBUIextDocumentFragment::css_tableCellBorder()
{
    ...
    BOBUIextTableCell cell = table->cellAt(0, 0);
    BOBUIextTableCellFormat cellFormat = cell.format().toTableCellFormat();
    QCOMPARE(cellFormat.leftBorder(), qreal(4));
    QCOMPARE(cellFormat.leftBorderBrush(), QBrush(QColor("red")));
    QCOMPARE(cellFormat.leftBorderStyle(), BOBUIextFrameFormat::BorderStyle_Dashed);

    QCOMPARE(cellFormat.rightBorder(), qreal(8));
    QCOMPARE(cellFormat.rightBorderBrush(), QBrush(QColor("green")));
    QCOMPARE(cellFormat.rightBorderStyle(), BOBUIextFrameFormat::BorderStyle_Groove);

    QCOMPARE(cellFormat.bottomBorder(), qreal(8));
    QCOMPARE(cellFormat.bottomBorderBrush(), QBrush(QColor("green")));
    QCOMPARE(cellFormat.bottomBorderStyle(), BOBUIextFrameFormat::BorderStyle_Groove);

    QCOMPARE(cellFormat.topBorder(), qreal(8));
    QCOMPARE(cellFormat.topBorderBrush(), QBrush(QColor("green")));
    QCOMPARE(cellFormat.topBorderStyle(), BOBUIextFrameFormat::BorderStyle_Groove);
}

void tst_BOBUIextDocumentFragment::css_tableCellBorderWidthOneValue() // BOBUIBUG-80496
{
...
void tst_BOBUIextDocumentFragment::css_tableCellBorderWidthTwoValues() // BOBUIBUG-80496
{
...
void tst_BOBUIextDocumentFragment::css_tableCellBorderShorthand()
{
    ...
    QCOMPARE(cellFormat.leftBorderStyle(), BOBUIextFrameFormat::BorderStyle_Solid);

    QCOMPARE(cellFormat.rightBorder(), qreal(2));
    QCOMPARE(cellFormat.rightBorderBrush(), QBrush(QColor("red")));
    QCOMPARE(cellFormat.rightBorderStyle(), BOBUIextFrameFormat::BorderStyle_Dashed);

    QCOMPARE(cellFormat.bottomBorder(), qreal(3));
    QCOMPARE(cellFormat.bottomBorderBrush(), QBrush(QColor("yellow")));
    QCOMPARE(cellFormat.bottomBorderStyle(), BOBUIextFrameFormat::BorderStyle_Dotted);

    QCOMPARE(cellFormat.topBorder(), qreal(4));
    QCOMPARE(cellFormat.topBorderBrush(), QBrush(QColor("blue")));
    QCOMPARE(cellFormat.topBorderStyle(), BOBUIextFrameFormat::BorderStyle_DotDash);
}

void tst_BOBUIextDocumentFragment::css_tableCellAllBordersShorthand()
{
    ...
    QCOMPARE(cellFormat.bottomBorder(), qreal(2));
    QCOMPARE(cellFormat.bottomBorderBrush(), QBrush(QColor("green")));
    QCOMPARE(cellFormat.bottomBorderStyle(), BOBUIextFrameFormat::BorderStyle_Dashed);

    QCOMPARE(cellFormat.topBorder(), qreal(2));
    QCOMPARE(cellFormat.topBorderBrush(), QBrush(QColor("green")));
    QCOMPARE(cellFormat.topBorderStyle(), BOBUIextFrameFormat::BorderStyle_Dashed);
}

void tst_BOBUIextDocumentFragment::css_tableCellOverrideOneBorder()
{
...
void tst_BOBUIextDocumentFragment::css_tableBorderCollapse()
{
...
void tst_BOBUIextDocumentFragment::css_cellPaddings()
{
...
void tst_BOBUIextDocumentFragment::css_whiteSpace_data()
{
    BOBUIest::addColumn<QString>("htmlText");
    BOBUIest::addColumn<bool>("nowrap");

    BOBUIest::newRow("default") << QString("<p>Normal Text</p>") << false;
    BOBUIest::newRow("white-space:nowrap") << QString("<p style=white-space:nowrap>Normal Text</p>") << true;
    BOBUIest::newRow("white-space:pre") << QString("<p style=white-space:pre>Normal Text</p>") << true;
}

void tst_BOBUIextDocumentFragment::css_whiteSpace()
{
...
void tst_BOBUIextDocumentFragment::html_blockLevelDiv()
{
    const char html[] = "<div align=right><b>Hello World";
    setHtml(html);

    QCOMPARE(doc->begin().blockFormat().alignment(), BobUI::AlignRight|BobUI::AlignAbsolute);
    QCOMPARE(doc->begin().next(), doc->end());
}

void tst_BOBUIextDocumentFragment::html_spanNesting()
{
    ...
    cursor.movePosition(BOBUIextCursor::Start);
    cursor.movePosition(BOBUIextCursor::NextCharacter);
    QVERIFY(cursor.charFormat().foreground() == BobUI::black);
    cursor.movePosition(BOBUIextCursor::NextCharacter);
    QVERIFY(cursor.charFormat().foreground() == BobUI::red);
    cursor.movePosition(BOBUIextCursor::NextCharacter);
    QVERIFY(cursor.charFormat().foreground() == BobUI::black);
    cursor.movePosition(BOBUIextCursor::NextCharacter);
    QVERIFY(cursor.charFormat().foreground() == BobUI::black);
...
void tst_BOBUIextDocumentFragment::html_nestedLists()
{
    const char html[] = "<p><ul><li>Foo<ul><li>In nested list</li></ul></li><li>Last item</li></ul></p>";
    setHtml(html);

    cursor.movePosition(BOBUIextCursor::Start);
    BOBUIextList *firstList = cursor.currentList();
    QVERIFY(firstList);
    QCOMPARE(firstList->format().indent(), 1);

    cursor.movePosition(BOBUIextCursor::NextBlock);
    BOBUIextList *secondList = cursor.currentList();
    QVERIFY(secondList);
    QVERIFY(secondList != firstList);
    QCOMPARE(cursor.currentList()->format().indent(), 2);

    cursor.movePosition(BOBUIextCursor::NextBlock);
    BOBUIextList *thirdList = cursor.currentList();
    QVERIFY(thirdList);
    QCOMPARE(thirdList, firstList);
}

void tst_BOBUIextDocumentFragment::noSpecialCharactersInPlainText()
{
    ...
    QVERIFY(!plain.contains(BOBUIextBeginningOfFrame));
    QVERIFY(!plain.contains(BOBUIextEndOfFrame));
    QVERIFY(!plain.contains(QChar::LineSeparator));

    plain = BOBUIextDocumentFragment(doc).toPlainText();
    QVERIFY(!plain.contains(QChar::ParagraphSeparator));
    QVERIFY(!plain.contains(QChar::Nbsp));
    QVERIFY(!plain.contains(BOBUIextBeginningOfFrame));
    QVERIFY(!plain.contains(BOBUIextEndOfFrame));
...
void tst_BOBUIextDocumentFragment::html_doNotInheritBackground()
{
    ...
    for (BOBUIextBlock block = doc->begin();
        ...
        QVERIFY(!block.blockFormat().hasProperty(BOBUIextFormat::BackgroundBrush));
    }

    QVERIFY(doc->rootFrame()->frameFormat().hasProperty(BOBUIextFormat::BackgroundBrush));
    QVERIFY(doc->rootFrame()->frameFormat().background().color() == BobUI::blue);
}

void tst_BOBUIextDocumentFragment::html_inheritBackgroundToInlineElements()
{
...
void tst_BOBUIextDocumentFragment::html_doNotInheritBackgroundFromBlockElements()
{
    ...
    for (BOBUIextBlock::Iterator it = block.begin();
        ...
        if (fragmentCount == 0) {
            ...
            QVERIFY(!fragment.charFormat().hasProperty(BOBUIextFormat::BackgroundBrush));
        }
    }
...
void tst_BOBUIextDocumentFragment::html_inheritBackgroundFromBlockElements()
{
...
void tst_BOBUIextDocumentFragment::html_nobr()
{
...
void tst_BOBUIextDocumentFragment::fromPlainText()
{
    QString plainText;
    plainText = "Hello\nWorld\r\nBlub";
    ...
    int blockCount = 0;
    for (BOBUIextBlock block = doc->begin(); block.isValid(); block = block.next()) {
...
void tst_BOBUIextDocumentFragment::fromPlainText2()
{
    doc->setPlainText("Hello World");
    QCOMPARE(BOBUIextDocumentFragment(doc).toPlainText(), doc->toPlainText());
}

void tst_BOBUIextDocumentFragment::html_closingImageTag()
{
...
void tst_BOBUIextDocumentFragment::html_emptyDocument()
{
    const char html[] = "<html><body><p style=\"-bobui-paragraph-type:empty;\"></p></body></html>";
    setHtml(html);
    QCOMPARE(doc->blockCount(), 1);
}

void tst_BOBUIextDocumentFragment::html_closingTag()
{
...
void tst_BOBUIextDocumentFragment::html_anchorAroundImage()
{
    ...
    cursor.movePosition(BOBUIextCursor::Start);
    cursor.movePosition(BOBUIextCursor::NextCharacter);
    BOBUIextImageFormat fmt = cursor.charFormat().toImageFormat();
    QCOMPARE(fmt.name(), QString("test.png"));
    QVERIFY(fmt.isAnchor());
    QCOMPARE(fmt.anchorHref(), QString("http://www.troll.no"));
}

void tst_BOBUIextDocumentFragment::html_floatBorder()
{
...
void tst_BOBUIextDocumentFragment::html_frameImport()
{
    ...
    cleanup();
    init();
    frag = BOBUIextDocumentFragment::fromHtml(frag.toHtml());
    cursor.insertFragment(frag);

    QList<BOBUIextFrame *> childFrames = doc->rootFrame()->childFrames();
    QCOMPARE(childFrames.size(), 1);
    BOBUIextFrame *frame = childFrames.first();
    QCOMPARE(frame->frameFormat().margin(), ffmt.margin());
    QCOMPARE(frame->frameFormat().border(), ffmt.border());
}

void tst_BOBUIextDocumentFragment::html_frameImport2()
{
    BOBUIextFrameFormat ffmt;
    ffmt.setBorder(1);
    ffmt.setPosition(BOBUIextFrameFormat::FloatRight);
...
void tst_BOBUIextDocumentFragment::html_dontAddMarginsAcrossTableCells()
{
...
void tst_BOBUIextDocumentFragment::html_dontMergeCenterBlocks()
{
    const char html[] = "<center>This should be centered</center>And this should not be centered anymore";
    cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(QString::fromLatin1(html)));

    QCOMPARE(doc->blockCount(), 2);
    BOBUIextBlock blk = doc->begin();
    QCOMPARE(blk.blockFormat().alignment(), BobUI::AlignCenter);
    blk = blk.next();
    QVERIFY(blk.blockFormat().alignment() != BobUI::AlignCenter);
}

void tst_BOBUIextDocumentFragment::html_tableCellBgColor()
{
    ...
    BOBUIextTableCell cell = table->cellAt(0, 0);
    QVERIFY(cell.format().background().color() == BobUI::blue);
}

void tst_BOBUIextDocumentFragment::html_tableCellBgColor2()
{
    ...
    BOBUIextFrame::Iterator it = cell.begin();
    QVERIFY(!it.atEnd());
    QVERIFY(!it.currentFrame());
    QVERIFY(it.currentBlock().isValid());
    ...
    QVERIFY(!it.currentFrame());
    QVERIFY(it.currentBlock().isValid());
    QCOMPARE(it.currentBlock().blockFormat().background(), QBrush(BobUI::NoBrush));

    ++it;
    QVERIFY(it.atEnd());
}

void tst_BOBUIextDocumentFragment::html_cellSkip()
{
    const char html[] = ""
"<table border>"
"  <tr>"
...
void tst_BOBUIextDocumentFragment::nonZeroMarginOnImport()
{
...
void tst_BOBUIextDocumentFragment::html_charFormatPropertiesUnset()
{
    setHtml("Hello World");
    QVERIFY(doc->begin().begin().fragment().charFormat().properties().isEmpty());
}

void tst_BOBUIextDocumentFragment::html_headings()
{
    setHtml("<h1>foo</h1>bar");
    QCOMPARE(doc->blockCount(), 2);
}

void tst_BOBUIextDocumentFragment::html_quotedFontFamily_data()
{
    BOBUIest::addColumn<QString>("html");
    BOBUIest::addColumn<QString>("fontFamily");
    BOBUIest::addColumn<QStringList>("fontFamilies");

    const QString fooFamily = QLatin1String("Foo Bar");
    const QString weirdFamily = QLatin1String("'Weird, & font '' name',");

    BOBUIest::newRow("data1") << QString("<div style=\"font-family: 'Foo Bar';\">Test</div>")
                           << fooFamily << QStringList(fooFamily);
    BOBUIest::newRow("data2") << QString("<div style='font-family: \"Foo  Bar\";'>Test</div>")
                           << QString("Foo  Bar") << QStringList("Foo  Bar");
    BOBUIest::newRow("data3") << QString("<div style='font-family: Foo\n  Bar;'>Test</div>")
                           << fooFamily << QStringList(fooFamily);
    BOBUIest::newRow("data4") << QString("<div style='font-family: Foo\n  Bar, serif, \"bar foo\";'>Test"
                                      "</div>")
                           << fooFamily << (QStringList() << "Foo Bar" << "serif" << "bar foo");
    BOBUIest::newRow("data5") << QString("<div style='font-family: \"\\'Weird, & font \\'\\' name\\',"
                                      "\";'>Test</div>")
                           << weirdFamily << QStringList(weirdFamily);
    BOBUIest::newRow("data6") << QString("<div style='font-family: \"\\'Weird, & font \\'\\' name\\',"
                                      "\";'>Test</div>")
                           << weirdFamily << QStringList(weirdFamily);
    BOBUIest::newRow("data7") << QString("<div style='font-family: \"\\'Weird, & font \\'\\' name\\',\", "
                                      "serif, \"bar foo\";'>Test</div>")
                            << weirdFamily
                            << (QStringList() << weirdFamily << "serif" << "bar foo");
}

void tst_BOBUIextDocumentFragment::html_quotedFontFamily()
{
    QFETCH(QString, html);
...
void tst_BOBUIextDocumentFragment::defaultFont()
{
    QFont f;
...
void tst_BOBUIextDocumentFragment::html_spanBackgroundColor()
{
    setHtml("<span style=\"background-color: blue\">Foo</span>");
    QVERIFY(doc->begin().begin().fragment().charFormat().background().color() == QColor(BobUI::blue));
}

void tst_BOBUIextDocumentFragment::html_brokenTitle_data()
{
    BOBUIest::addColumn<QString>("html");
    BOBUIest::addColumn<QString>("expectedBody");
    BOBUIest::addColumn<QString>("expectedTitle");

    BOBUIest::newRow("brokentitle") << QString("<html><head><title>Foo<b>bar</b></title></head><body>Blah</body></html>")
                                 << QString("Blah") << QString("Foo");
    BOBUIest::newRow("brokentitle2") << QString("<html><head><title>Foo<font color=red>i</font>t<font color=red>i</font>Blub</title></head><body>Blah</body></html>")
                                 << QString("Blah") << QString("Foo");
    BOBUIest::newRow("entities") << QString("<html><head><title>Foo&lt;bar</title></head><body>Blah</body></html>")
                              << QString("Blah") << QString("Foo<bar");
    BOBUIest::newRow("unclosedtitle") << QString("<html><head><title>Foo</head><body>Blah</body></html>")
                                   << QString("Blah") << QString("Foo");
}

void tst_BOBUIextDocumentFragment::html_brokenTitle()
{
    QFETCH(QString, html);
    ...
    QCOMPARE(doc->metaInformation(BOBUIextDocument::DocumentTitle), expectedTitle);
}

void tst_BOBUIextDocumentFragment::html_blockVsInline()
{
    {
...
void tst_BOBUIextDocumentFragment::html_tbody()
{
...
void tst_BOBUIextDocumentFragment::html_nestedTables()
{
    setHtml("<table>"
            "  <tr><td>"
            ""
    ...
    BOBUIextTable *firstNestedTable = cursor.currentTable();
    ...
    BOBUIextTable *secondNestedTable = cursor.currentTable();
...
void tst_BOBUIextDocumentFragment::html_rowSpans()
{
    setHtml(""
...
void tst_BOBUIextDocumentFragment::html_rowSpans2()
{
    setHtml(""
            "<html><body>"
            "<table border=\"1\">"
...
void tst_BOBUIextDocumentFragment::html_implicitParagraphs()
{
    setHtml("<p>foo</p>bar");
    QCOMPARE(doc->blockCount(), 2);
}

void tst_BOBUIextDocumentFragment::html_missingCloseTag()
{
...
void tst_BOBUIextDocumentFragment::html_anchorColor()
{
    ...
    cursor.movePosition(BOBUIextCursor::Start);
    cursor.movePosition(BOBUIextCursor::NextCharacter);
    QVERIFY(cursor.charFormat().foreground().color() == BobUI::yellow);
}

void tst_BOBUIextDocumentFragment::html_lastParagraphClosing()
{
    setHtml("<p>Foo<b>Bar</b>Baz");
    QCOMPARE(doc->blockCount(), 1);
}

void tst_BOBUIextDocumentFragment::html_tableHeaderBodyFootParent()
{
...
void tst_BOBUIextDocumentFragment::html_columnWidths()
{
    setHtml("<table>"
            " <tr>"
            "   <td colspan=\"2\">Foo</td>"
    ...
    const QList<BOBUIextLength> columnWidths = fmt.columnWidthConstraints();
    QCOMPARE(columnWidths.size(), 2);
    QCOMPARE(columnWidths.at(0).type(), BOBUIextLength::VariableLength);
    QCOMPARE(columnWidths.at(1).type(), BOBUIextLength::PercentageLength);
    QCOMPARE(columnWidths.at(1).rawValue(), qreal(1));
}

void tst_BOBUIextDocumentFragment::css_fontWeight()
{
...
void tst_BOBUIextDocumentFragment::css_float()
{
    setHtml("<img src=\"foo\" style=\"float: right\">");
    BOBUIextCharFormat fmt = doc->begin().begin().fragment().charFormat();
    QVERIFY(fmt.isImageFormat());
    BOBUIextObject *o = doc->objectForFormat(fmt);
    QVERIFY(o);
    BOBUIextFormat f = o->format();
    QVERIFY(f.isFrameFormat());
    QCOMPARE(f.toFrameFormat().position(), BOBUIextFrameFormat::FloatRight);
    ...
    f = o->format();
    QVERIFY(f.isFrameFormat());
    QCOMPARE(f.toFrameFormat().position(), BOBUIextFrameFormat::FloatLeft);
}

void tst_BOBUIextDocumentFragment::css_textIndent()
{
...
void tst_BOBUIextDocumentFragment::css_inline()
{
    setHtml(""
            "<style>"
...
void tst_BOBUIextDocumentFragment::css_external()
{
    doc->addResource(BOBUIextDocument::StyleSheetResource, QUrl("test.css"), QString("p { background-color: green; }"));
    doc->setHtml(""
...
void tst_BOBUIextDocumentFragment::css_import()
{
    const QColor green("green");
    doc->addResource(BOBUIextDocument::StyleSheetResource, QUrl("test.css"), QString("@import \"other.css\";"));
    doc->addResource(BOBUIextDocument::StyleSheetResource, QUrl("other.css"), QString("@import url(\"other2.css\");"));
    doc->addResource(BOBUIextDocument::StyleSheetResource, QUrl("other2.css"), QString("p { background-color: green; }"));
    doc->setHtml(""
            "<link href=\"test.css\" type=\"text/css\" />"
            "<p>test</p>"
            );
...
void tst_BOBUIextDocumentFragment::css_selectors_data()
{
    BOBUIest::addColumn<bool>("match");
    BOBUIest::addColumn<QString>("selector");
    BOBUIest::addColumn<QString>("attributes");

    BOBUIest::newRow("plain") << true << QString() << QString();

    BOBUIest::newRow("class") << true << QString(".foo") << QString("class=foo");
    BOBUIest::newRow("notclass") << false << QString(".foo") << QString("class=bar");

    BOBUIest::newRow("attrset") << true << QString("[justset]") << QString("justset");
    BOBUIest::newRow("notattrset") << false << QString("[justset]") << QString("otherattribute");

    BOBUIest::newRow("attrmatch") << true << QString("[foo=bar]") << QString("foo=bar");
    BOBUIest::newRow("noattrmatch") << false << QString("[foo=bar]") << QString("foo=xyz");

    BOBUIest::newRow("contains") << true << QString("[foo~=bar]") << QString("foo=\"baz bleh bar\"");
    BOBUIest::newRow("notcontains") << false << QString("[foo~=bar]") << QString("foo=\"test\"");

    BOBUIest::newRow("beingswith") << true << QString("[foo|=bar]") << QString("foo=\"bar-bleh\"");
    BOBUIest::newRow("notbeingswith") << false << QString("[foo|=bar]") << QString("foo=\"bleh-bar\"");

    BOBUIest::newRow("attr2") << true << QString("[bar=foo]") << QString("bleh=bar bar=foo");
}

void tst_BOBUIextDocumentFragment::css_selectors()
{
    QFETCH(bool, match);
...
void tst_BOBUIextDocumentFragment::css_nodeNameCaseInsensitivity()
{
    setHtml("<style>"
            "P { background-color: green }"
            "</style>"
...
void tst_BOBUIextDocumentFragment::css_textUnderlineStyle_data()
{
    BOBUIest::addColumn<QString>("styleName");
    BOBUIest::addColumn<int>("expectedStyle");

    BOBUIest::newRow("none") << QString("none") << int(BOBUIextCharFormat::NoUnderline);
    BOBUIest::newRow("solid") << QString("solid") << int(BOBUIextCharFormat::SingleUnderline);
    BOBUIest::newRow("dash") << QString("dashed") << int(BOBUIextCharFormat::DashUnderline);
    BOBUIest::newRow("dot") << QString("dotted") << int(BOBUIextCharFormat::DotLine);
    BOBUIest::newRow("dashdot") << QString("dot-dash") << int(BOBUIextCharFormat::DashDotLine);
    BOBUIest::newRow("dashdotdot") << QString("dot-dot-dash") << int(BOBUIextCharFormat::DashDotDotLine);
    BOBUIest::newRow("wave") << QString("wave") << int(BOBUIextCharFormat::WaveUnderline);
}

void tst_BOBUIextDocumentFragment::css_textUnderlineStyle()
{
    ...
    BOBUIextFragment fragment = doc->begin().begin().fragment();
    QVERIFY(fragment.isValid());
    QCOMPARE(int(fragment.charFormat().underlineStyle()), expectedStyle);
}

void tst_BOBUIextDocumentFragment::css_textUnderlineStyleAndDecoration()
{
    doc->setHtml("<span style=\"text-decoration: overline; text-underline-style: solid\">Test</span>");

    BOBUIextFragment fragment = doc->begin().begin().fragment();
    QVERIFY(fragment.isValid());
    QCOMPARE(fragment.charFormat().underlineStyle(), BOBUIextCharFormat::SingleUnderline);
...
void tst_BOBUIextDocumentFragment::css_listStyleType()
{
    ...
    cursor.movePosition(BOBUIextCursor::End);
    QVERIFY(cursor.currentList());
    QCOMPARE(cursor.currentList()->format().style(), BOBUIextListFormat::ListSquare);
    ...
    cursor.movePosition(BOBUIextCursor::End);
    QVERIFY(cursor.currentList());
    QCOMPARE(cursor.currentList()->format().style(), BOBUIextListFormat::ListDecimal);

    doc->setHtml("<ul style=\"list-style-type: lower-alpha\"><li>Blah</li></ul>");
    cursor.movePosition(BOBUIextCursor::End);
    QVERIFY(cursor.currentList());
    QCOMPARE(cursor.currentList()->format().style(), BOBUIextListFormat::ListLowerAlpha);

    doc->setHtml("<ul style=\"list-style-type: upper-alpha\"><li>Blah</li></ul>");
    cursor.movePosition(BOBUIextCursor::End);
    QVERIFY(cursor.currentList());
    QCOMPARE(cursor.currentList()->format().style(), BOBUIextListFormat::ListUpperAlpha);

    doc->setHtml("<ul style=\"list-style-type: upper-roman\"><li>Blah</li></ul>");
    cursor.movePosition(BOBUIextCursor::End);
    QVERIFY(cursor.currentList());
    QCOMPARE(cursor.currentList()->format().style(), BOBUIextListFormat::ListUpperRoman);

    doc->setHtml("<ul style=\"list-style-type: lower-roman\"><li>Blah</li></ul>");
    cursor.movePosition(BOBUIextCursor::End);
    QVERIFY(cursor.currentList());
    QCOMPARE(cursor.currentList()->format().style(), BOBUIextListFormat::ListLowerRoman);
...
void tst_BOBUIextDocumentFragment::css_linkPseudo()
{
...
void tst_BOBUIextDocumentFragment::css_pageBreaks()
{
    doc->setHtml("<p>Foo</p>");
    QCOMPARE(doc->begin().blockFormat().pageBreakPolicy(), BOBUIextFormat::PageBreak_Auto);

    doc->setHtml("<p style=\" page-break-before:always;\">Foo</p>");
    QCOMPARE(doc->begin().blockFormat().pageBreakPolicy(), BOBUIextFormat::PageBreak_AlwaysBefore);

    doc->setHtml("<p style=\" page-break-after:always;\">Foo</p>");
    QCOMPARE(doc->begin().blockFormat().pageBreakPolicy(), BOBUIextFormat::PageBreak_AlwaysAfter);

    doc->setHtml("<p style=\" page-break-before:always; page-break-after:always;\">Foo</p>");
    QVERIFY(doc->begin().blockFormat().pageBreakPolicy() == (BOBUIextFormat::PageBreak_AlwaysAfter | BOBUIextFormat::PageBreak_AlwaysBefore));
}

void tst_BOBUIextDocumentFragment::universalSelectors_data()
{
    BOBUIest::addColumn<bool>("match");
    BOBUIest::addColumn<QString>("selector");
    BOBUIest::addColumn<QString>("attributes");

    BOBUIest::newRow("1") << true << QString("*") << QString();
    BOBUIest::newRow("2") << false << QString() << QString(); // invalid totally empty selector

    BOBUIest::newRow("3") << false << QString("*[foo=bar]") << QString("foo=bleh");
    BOBUIest::newRow("4") << true << QString("*[foo=bar]") << QString("foo=bar");

    BOBUIest::newRow("5") << false << QString("[foo=bar]") << QString("foo=bleh");
    BOBUIest::newRow("6") << true << QString("[foo=bar]") << QString("foo=bar");

    BOBUIest::newRow("7") << true << QString(".charfmt1") << QString("class=charfmt1");
}

void tst_BOBUIextDocumentFragment::universalSelectors()
{
    QFETCH(bool, match);
    QFETCH(QString, selector);
    QFETCH(QString, attributes);
...
void tst_BOBUIextDocumentFragment::screenMedia()
{
    const QColor green("green");
    setHtml("<style>"
            "@media screen {"
...
void tst_BOBUIextDocumentFragment::htmlResourceLoading()
{
    const QString html("<link href=\"test.css\" type=\"text/css\" />"
                                   "<p>test</p>");

    BOBUIextDocument tmp;
    tmp.addResource(BOBUIextDocument::StyleSheetResource, QUrl("test.css"), QString("p { background-color: green; }"));
    BOBUIextDocumentFragment frag = BOBUIextDocumentFragment::fromHtml(html, &tmp);
    doc->clear();
    BOBUIextCursor(doc).insertFragment(frag);
    BOBUIextBlockFormat fmt = doc->begin().blockFormat();
    QCOMPARE(fmt.background().color(), QColor("green"));
}

void tst_BOBUIextDocumentFragment::someCaseInsensitiveAttributeValues()
{
    ...
    QCOMPARE(doc->begin().blockFormat().alignment(), BobUI::AlignHCenter);

    const char html3[] = "<p dir=rTL><b>Hello World";
    setHtml(html3);

    QCOMPARE(doc->begin().blockFormat().layoutDirection(), BobUI::RightToLeft);
}
...
void tst_BOBUIextDocumentFragment::leftMarginInsideHtml()
{
...
void tst_BOBUIextDocumentFragment::html_margins()
{
...
void tst_BOBUIextDocumentFragment::newlineInsidePreShouldBecomeNewParagraph()
{
...
void tst_BOBUIextDocumentFragment::invalidColspan()
{
...
void tst_BOBUIextDocumentFragment::html_brokenTableWithJustTr()
{
...
void tst_BOBUIextDocumentFragment::html_brokenTableWithJustTd()
{
...
void tst_BOBUIextDocumentFragment::html_preNewlineHandling_data()
{
    BOBUIest::addColumn<QString>("html");
    BOBUIest::addColumn<QString>("expectedPlainText");

    BOBUIest::newRow("pre1") << QString("Foo<pre>Bar")
                          << QString("Foo\nBar");
    BOBUIest::newRow("pre2") << QString("Foo<pre>\nBar")
                          << QString("Foo\nBar");
    BOBUIest::newRow("pre3") << QString("Foo<pre>\n\nBar")
                          << QString("Foo\n\nBar");
    BOBUIest::newRow("pre4") << QString("<html>Foo<pre>\nBar")
                          << QString("Foo\nBar");
    BOBUIest::newRow("pre5") << QString("<pre>Foo\n</pre>\nBar")
                          << QString("Foo\nBar");
    BOBUIest::newRow("pre6") << QString("<pre>Foo<b>Bar</b>Blah\n</pre>\nMooh")
                          << QString("FooBarBlah\nMooh");
    BOBUIest::newRow("pre7") << QString("<pre>\nPara1\n</pre>\n<pre>\nPara2\n</pre>")
                          << QString("Para1\nPara2");
}

void tst_BOBUIextDocumentFragment::html_preNewlineHandling()
{
    QFETCH(QString, html);

    doc->setHtml(html);
    BOBUIEST(doc->toPlainText(), "expectedPlainText");
}

void tst_BOBUIextDocumentFragment::html_br()
{
    doc->setHtml("Foo<br><br><br>Blah");
    QCOMPARE(doc->toPlainText(), QString("Foo\n\n\nBlah"));
}

void tst_BOBUIextDocumentFragment::html_dl()
{
    doc->setHtml("<dl><dt>term<dd>data</dl>Text afterwards");
    QCOMPARE(doc->toPlainText(), QString("term\ndata\nText afterwards"));
}

void tst_BOBUIextDocumentFragment::html_tableStrangeNewline()
{
    ...
    QCOMPARE(table->rows(), 1);
    QCOMPARE(table->columns(), 1);
    const BOBUIextTableCell cell = table->cellAt(0, 0);
...
void tst_BOBUIextDocumentFragment::html_tableStrangeNewline2()
{
...
void tst_BOBUIextDocumentFragment::html_tableStrangeNewline3()
{
...
void tst_BOBUIextDocumentFragment::html_caption()
{
...
void tst_BOBUIextDocumentFragment::html_windowsEntities()
{
...
void tst_BOBUIextDocumentFragment::html_eatenText()
{
...
void tst_BOBUIextDocumentFragment::html_hr()
{
    doc->setHtml("<hr />");
    QCOMPARE(doc->blockCount(), 1);
    QVERIFY(doc->begin().blockFormat().hasProperty(BOBUIextFormat::BlockTrailingHorizontalRulerWidth));
    doc->setHtml("<hr style=\"background-color:green;\"/>");
    QCOMPARE(doc->blockCount(), 1);
    QVERIFY(doc->begin().blockFormat().hasProperty(BOBUIextFormat::BlockTrailingHorizontalRulerWidth));
    QVERIFY(doc->begin().blockFormat().hasProperty(BOBUIextFormat::BackgroundBrush));
    const auto brush = qvariant_cast<QBrush>(doc->begin().blockFormat().property(BOBUIextFormat::BackgroundBrush));
    QCOMPARE(brush.color(), QColor("green"));
}

void tst_BOBUIextDocumentFragment::html_hrMargins()
{
...
void tst_BOBUIextDocumentFragment::html_blockQuoteMargins()
{
...
void tst_BOBUIextDocumentFragment::html_definitionListMargins()
{
...
void tst_BOBUIextDocumentFragment::html_listMargins()
{
...
void tst_BOBUIextDocumentFragment::html_titleAttribute()
{
...
void tst_BOBUIextDocumentFragment::html_compressDivs()
{
...
void tst_BOBUIextDocumentFragment::completeToPlainText()
{
...
void tst_BOBUIextDocumentFragment::copyContents()
{
    doc->setPlainText("Hello");
    QFont f;
    doc->setDefaultFont(f);
    ...
    f.setPointSize(48);
    doc->setDefaultFont(f);
    BOBUIextCursor(doc).insertFragment(BOBUIextDocumentFragment::fromHtml(frag.toHtml()));
    fragment = doc->begin().begin().fragment();
    QCOMPARE(fragment.text(), QString("Hello"));
    QCOMPARE(fragment.charFormat().font().pointSize(), f.pointSize());
}

void tst_BOBUIextDocumentFragment::html_textAfterHr()
{
    doc->setHtml("<hr><nobr><b>After the centered text</b></nobr>");
    QCOMPARE(doc->blockCount(), 2);
    BOBUIextBlock block = doc->begin();
    QVERIFY(block.text().isEmpty());
    QVERIFY(block.blockFormat().hasProperty(BOBUIextFormat::BlockTrailingHorizontalRulerWidth));
    block = block.next();
...
void tst_BOBUIextDocumentFragment::blockTagClosing()
{
...
void tst_BOBUIextDocumentFragment::isEmpty()
{
    BOBUIextDocumentFragment frag;
    QVERIFY(frag.isEmpty());
    frag = BOBUIextDocumentFragment::fromHtml("test");
    QVERIFY(!frag.isEmpty());
    frag = BOBUIextDocumentFragment::fromHtml("<hr />");
    QVERIFY(!frag.isEmpty());
}

void tst_BOBUIextDocumentFragment::html_alignmentInheritance()
{
    doc->setHtml("<center>Centered text<hr></center><b>After the centered text</b>");
    QCOMPARE(doc->blockCount(), 3);
    BOBUIextBlock block = doc->begin();
    QVERIFY(block.blockFormat().alignment() & BobUI::AlignHCenter);
    block = block.next();
    QVERIFY(block.blockFormat().alignment() & BobUI::AlignHCenter);
    block = block.next();
    QVERIFY(!(block.blockFormat().alignment() & BobUI::AlignHCenter));
...
void tst_BOBUIextDocumentFragment::html_ignoreEmptyDivs()
{
...
void tst_BOBUIextDocumentFragment::html_dontInheritAlignmentForFloatingImages()
{
    ...
    BOBUIextFormat f = o->format();
    QVERIFY(f.isFrameFormat());
    QCOMPARE(f.toFrameFormat().position(), BOBUIextFrameFormat::InFlow);
}

void tst_BOBUIextDocumentFragment::html_verticalImageAlignment()
{
    ...
    BOBUIextImageFormat fmt = cursor.charFormat().toImageFormat();
    QCOMPARE(fmt.verticalAlignment(), BOBUIextCharFormat::AlignNormal);
    ...
    QCOMPARE(fmt.verticalAlignment(), BOBUIextCharFormat::AlignMiddle);
    ...
    QVERIFY(cursor.charFormat().isImageFormat());
    fmt = cursor.charFormat().toImageFormat();
    QCOMPARE(fmt.verticalAlignment(), BOBUIextCharFormat::AlignTop);
...
void tst_BOBUIextDocumentFragment::html_verticalCellAlignment()
{
    const char *alt[] =
    {
    ...
    for (int i = 0; i < numTestCases; ++i) {
        ...
        BOBUIextTable *table = qobject_cast<BOBUIextTable *>(doc->rootFrame()->childFrames().at(0));
        QVERIFY(table);

        QCOMPARE(table->cellAt(0, 0).format().verticalAlignment(), BOBUIextCharFormat::AlignMiddle);
        QCOMPARE(table->cellAt(0, 1).format().verticalAlignment(), BOBUIextCharFormat::AlignTop);
        QCOMPARE(table->cellAt(0, 2).format().verticalAlignment(), BOBUIextCharFormat::AlignBottom);
    }
}

void tst_BOBUIextDocumentFragment::html_borderColor()
{
    ...
    cursor.movePosition(BOBUIextCursor::NextBlock);
    QVERIFY(cursor.currentTable());
    QCOMPARE(cursor.currentTable()->format().borderStyle(), BOBUIextFrameFormat::BorderStyle_Outset);
    QCOMPARE(cursor.currentTable()->format().borderBrush(), QBrush(QColor("#0000ff")));
}

void tst_BOBUIextDocumentFragment::html_borderStyle()
{
    ...
    cursor.movePosition(BOBUIextCursor::NextBlock);
    QVERIFY(cursor.currentTable());
    QCOMPARE(cursor.currentTable()->format().borderStyle(), BOBUIextFrameFormat::BorderStyle_Solid);
    QCOMPARE(cursor.currentTable()->format().borderBrush(), QBrush(BobUI::darkGray));
}

void tst_BOBUIextDocumentFragment::html_borderWidth()
{
    const char *html[2] = { "<table style=\"border-width:2;\"><tr><td>Foo</td></tr></table>",
                            "<table style=\"border-width:2px;\"><tr><td>Foo</td></tr></table>" };

    for (int i = 0; i < 2; ++i) {
        cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(QString::fromLatin1(html[i])));
        cursor.movePosition(BOBUIextCursor::Start);
        cursor.movePosition(BOBUIextCursor::NextBlock);
        QVERIFY(cursor.currentTable());
...
void tst_BOBUIextDocumentFragment::html_userState()
{
    const char html[] = "<p style=\"-bobui-user-state:42;\">A</p><p style=\"-bobui-user-state:0;\">B</p><p>C</p>";
    cursor.insertFragment(BOBUIextDocumentFragment::fromHtml(QString::fromLatin1(html)));
    BOBUIextBlock block = doc->begin();
...
void tst_BOBUIextDocumentFragment::html_rootFrameProperties()
{
    const char html[] = "<table border=1 style=\"-bobui-table-type:root; margin-top:10px;\"><tr><td>Foo</tr></td>";
    doc->setHtml(html);
...
void tst_BOBUIextDocumentFragment::html_appendList()
{
    appendHtml("<p>foo</p>");
...
void tst_BOBUIextDocumentFragment::html_appendList2()
{
    appendHtml("1");
...
void tst_BOBUIextDocumentFragment::html_alignmentPropertySet()
{
    const char html[] = "<p>Test</p>";
    setHtml(QString::fromLatin1(html));
    QVERIFY(!doc->begin().blockFormat().hasProperty(BOBUIextFormat::BlockAlignment));
}

void tst_BOBUIextDocumentFragment::html_bobui3RichtextWhitespaceMode()
{
...
void tst_BOBUIextDocumentFragment::html_brAfterHr()
{
...
void tst_BOBUIextDocumentFragment::html_unclosedHead()
{
...
// duplicated from bobuiexthtmlparser.cpp
...
void tst_BOBUIextDocumentFragment::html_entities_data()
{
    BOBUIest::addColumn<QString>("html");
    BOBUIest::addColumn<quint16>("code");

    for (int i = 0; i < MAX_ENTITY; ++i) {
        BOBUIest::newRow(entities[i].name) << QString("<pre>&") + QString::fromLatin1(entities[i].name) + QString(";</pre>")
                                        << entities[i].code;
    }
}

void tst_BOBUIextDocumentFragment::html_entities()
{
    QFETCH(QString, html);
    QFETCH(quint16, code);
...
void tst_BOBUIextDocumentFragment::html_ignore_script()
{
    doc->setHtml(QString::fromLatin1("<html><script>Test</script><body>Blah</body></html>"));
    QCOMPARE(doc->toPlainText(), QString("Blah"));
}

void tst_BOBUIextDocumentFragment::html_directionWithHtml()
{
    doc->setHtml(QString::fromLatin1("<html><body><p>Test<p dir=rtl>RTL<p dir=ltr>LTR"));
    QCOMPARE(doc->blockCount(), 3);

    BOBUIextBlock block = doc->firstBlock();
    QVERIFY(block.blockFormat().hasProperty(BOBUIextFormat::LayoutDirection));
    QVERIFY(block.blockFormat().layoutDirection() == BobUI::LeftToRight); // HTML default

    block = block.next();
    QVERIFY(block.blockFormat().hasProperty(BOBUIextFormat::LayoutDirection));
    QCOMPARE(block.blockFormat().layoutDirection(), BobUI::RightToLeft);

    block = block.next();
    QVERIFY(block.blockFormat().hasProperty(BOBUIextFormat::LayoutDirection));
    QCOMPARE(block.blockFormat().layoutDirection(), BobUI::LeftToRight);
}

void tst_BOBUIextDocumentFragment::html_directionWithRichText()
{
...
void tst_BOBUIextDocumentFragment::html_metaInBody()
{
    setHtml("<body>Hello<meta>World</body>");
    QCOMPARE(doc->toPlainText(), QString("HelloWorld"));
}

void tst_BOBUIextDocumentFragment::html_importImageWithoutAspectRatio()
{
    ...
    QVERIFY (fmt.hasProperty(BOBUIextFormat::ImageWidth));
    ...
    QVERIFY(cursor.charFormat().isImageFormat());
    fmt = cursor.charFormat().toImageFormat();
    QVERIFY (! fmt.hasProperty(BOBUIextFormat::ImageHeight));
    QCOMPARE (fmt.width(), 200.);
}

void tst_BOBUIextDocumentFragment::html_fromFirefox()
{
...
void tst_BOBUIextDocumentFragment::html_emptyInlineInsideBlock()
{
...
void tst_BOBUIextDocumentFragment::css_fontAndWordSpacing()
{
    {
        ...
        cursor.movePosition(BOBUIextCursor::Start);
        cursor.movePosition(BOBUIextCursor::NextCharacter);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontLetterSpacing).toInt(), 13);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontLetterSpacingType).toUInt(),
                 (uint)(QFont::AbsoluteSpacing));
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontWordSpacing).toInt(), 15);
    }
    {
        ...
        cursor.movePosition(BOBUIextCursor::Start);
        cursor.movePosition(BOBUIextCursor::NextCharacter);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontLetterSpacing).toInt(), 200);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontLetterSpacingType).toUInt(),
                 (uint)(QFont::PercentageSpacing));
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontWordSpacing).toInt(), 0);
    }
    {
        ...
        cursor.movePosition(BOBUIextCursor::Start);
        cursor.movePosition(BOBUIextCursor::NextCharacter);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontLetterSpacing).toInt(), 100);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontLetterSpacingType).toUInt(),
                 (uint)(QFont::PercentageSpacing));
    }
    {
        ...
        cursor.movePosition(BOBUIextCursor::Start);
        cursor.movePosition(BOBUIextCursor::NextCharacter);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontLetterSpacing).toInt(), 50);
        QCOMPARE(cursor.charFormat().property(BOBUIextFormat::FontLetterSpacingType).toUInt(),
                 (uint)(QFont::PercentageSpacing));
    }
}

void tst_BOBUIextDocumentFragment::html_brWithWhitespaceAfterList() // BOBUIBUG-81662
{
...
BOBUIEST_MAIN(tst_BOBUIextDocumentFragment)
#include "tst_bobuiextdocumentfragment.moc"
