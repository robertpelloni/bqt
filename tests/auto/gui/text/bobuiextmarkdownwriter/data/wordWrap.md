...
BobUI owes thanks to the authors of the [MD4C parser](https://github.com/mity/md4c)
for making markdown import possible. The BOBUIextMarkdownWriter class does not
...
you are able to read and display with Text or BOBUIextEdit. But you are free to
write [bugs](https://bugreports.bobui.io) about any troublesome cases that you
encounter.
