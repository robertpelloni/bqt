...
class tst_BobUIJson: public QObject
{
    Q_OBJECT
...
void tst_BobUIJson::initTestCase()
{
...
void tst_BobUIJson::compareCompiles()
{
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonArray>();
    BOBUIestPrivate::testAllComparisonOperatorsCompile<QJsonArray::iterator>();
    BOBUIestPrivate::testAllComparisonOperatorsCompile<QJsonArray::const_iterator>();
    BOBUIestPrivate::testAllComparisonOperatorsCompile<QJsonArray::iterator,
                                                    QJsonArray::const_iterator>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonDocument>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonObject>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonObject::iterator>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonObject::const_iterator>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonValue>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonValueConstRef>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonValueRef>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonArray, QJsonValue>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonObject, QJsonValue>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonObject, QJsonValueConstRef>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonObject, QJsonValueRef>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonValueConstRef, QJsonValue>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonValueRef, QJsonValue>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonValueRef, QJsonValueConstRef>();
    BOBUIestPrivate::testEqualityOperatorsCompile<QJsonObject::iterator,
                                               QJsonObject::const_iterator>();
}

void tst_BobUIJson::testValueSimple()
{
    QJsonObject object;
...
void tst_BobUIJson::testNumbers()
{
    {
        int numbers[] = {
            0,
...
void tst_BobUIJson::testNumbers_2()
{
    ...
    BOBUI_TEST_EQUALITY_OPS(jValue2.toObject(), jDocument2.object(), true);
    BOBUI_TEST_EQUALITY_OPS(jValue1, jValue2, true);
    BOBUI_TEST_EQUALITY_OPS(jDocument1, jDocument2, true);
...
void tst_BobUIJson::testNumbers_3()
{
    // test case from BOBUIBUG-31926
    ...
    BOBUI_TEST_EQUALITY_OPS(jValue1, jValue2, true);
    BOBUI_TEST_EQUALITY_OPS(jValue2.toObject(), jDocument2.object(), true);
    BOBUI_TEST_EQUALITY_OPS(jDocument1, QJsonDocument(), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonDocument(), QJsonDocument(), true);
...
void tst_BobUIJson::testNumbers_4()
{
    ...
    BOBUI_TEST_EQUALITY_OPS(doc1, doc2, false);
}

void tst_BobUIJson::testNumberComparisons()
{
...
BOBUI_WARNING_DISABLE_CLANG("-Wimplicit-const-int-float-conversion")
...
void tst_BobUIJson::testObjectSimple()
{
    QJsonObject object;
    object.insert("number", 999.);
    ...
    BOBUI_TEST_EQUALITY_OPS(object.value("value"), value, true);
    ...
    BOBUI_TEST_EQUALITY_OPS(taken, value, true);
...
void tst_BobUIJson::testObjectTakeDetach()
{
...
void tst_BobUIJson::testObjectSmallKeys()
{
    QJsonObject data1;
...
void tst_BobUIJson::testObjectInsertCopies()
{
    {
        QJsonObject obj;
        obj["prop1"] = "TEST";
    ...
    }
    {
        ...
        QCOMPARE(obj.value("value"), "TEST");
        QCOMPARE(obj.value("prop2"), "TEST");
        BOBUI_TEST_EQUALITY_OPS(rv, obj["value"].toObject(), true);
    }
    {
        QJsonObject obj;
        obj["value"] = "TEST";
        ...
        QCOMPARE(obj.size(), 2);
        QCOMPARE(obj.value("value"), "TEST");
        QEXPECT_FAIL("", "BOBUIBUG-83398: design flaw: the obj[] call invalidates the QJsonValueRef", Continue);
        QCOMPARE(obj.value("prop2"), "TEST");
    }
    {
        QJsonObject obj;
...
void tst_BobUIJson::testObjectInsertNonAscii()
{
    {
...
void tst_BobUIJson::testArraySimple()
{
    QJsonArray array;
    array.append(999.);
...
void tst_BobUIJson::testArrayInsertCopies()
{
    {
        QJsonArray array;
        array.append("TEST");
...
void tst_BobUIJson::testValueObject()
{
    QJsonObject object;
    object.insert("number", 999.);
...
void tst_BobUIJson::testValueArray()
{
    QJsonArray array;
...
void tst_BobUIJson::testObjectNested()
{
    ...
    BOBUI_TEST_EQUALITY_OPS(v.toObject(), inner, true);
    BOBUI_TEST_EQUALITY_OPS(v.toObject(otherObject), inner, true);

    inner.insert("number", 999.);
    outer.insert("nested", inner);
    BOBUI_TEST_EQUALITY_OPS(outer, inner, false);
    ...
    QCOMPARE(outer.value("nested").toObject().value("nested").toObject().value("boolean").toBool(),
             true);
    BOBUI_TEST_EQUALITY_OPS(outer.value("nested").toObject().value("nested").toObject(), twoDeep, true);
}

void tst_BobUIJson::testArrayNested()
{
    ...
    BOBUI_TEST_EQUALITY_OPS(outer.last().toObject(), object, true);
...
void tst_BobUIJson::testArrayNestedEmpty()
{
    QJsonObject object;
    QJsonArray inner;
    ...
    BOBUI_TEST_EQUALITY_OPS(QJsonDocument(), QJsonDocument(value), false);
...
void tst_BobUIJson::testObjectNestedEmpty()
{
    QJsonObject object;
    QJsonObject inner;
    QJsonObject inner2;
    ...
    QCOMPARE(value.size(), 0);
    QCOMPARE(value, inner);
    BOBUI_TEST_EQUALITY_OPS(value, inner, true);
    QCOMPARE(value.size(), 0);
    object.insert("count", 0.);
...
void tst_BobUIJson::testArrayEquality_data()
{
    BOBUIest::addColumn<QJsonArray>("array1");
    BOBUIest::addColumn<QJsonArray>("array2");
    BOBUIest::addColumn<bool>("expectedResult");
    BOBUIest::addRow("QJsonArray(), QJsonArray{665, 666, 667}")
                   << QJsonArray() << QJsonArray{665, 666, 667} << false;
    BOBUIest::addRow("QJsonArray(), QJsonArray{}")
            << QJsonArray() << QJsonArray{} <<true;
    BOBUIest::addRow("QJsonArray(), QJsonArray{123, QLatin1String(\"foo\")}")
...
void tst_BobUIJson::testArrayEquality()
{
    ...
    BOBUI_TEST_EQUALITY_OPS(array1, array2, expectedResult);
    BOBUI_TEST_EQUALITY_OPS(value, array2, expectedResult);
}

void tst_BobUIJson::testArrayComfortOperators()
{
    QJsonArray first;
    first.append(123.);
...
void tst_BobUIJson::testValueRef()
{
    QJsonArray array;
    array.append(1.);
    array.append(2.);
...
void tst_BobUIJson::testValueRefComparison()
{
    QJsonValue a0 = 42.;
...
#define CHECK(lhs, rhs, ineq) \
    ...
    BOBUI_TEST_EQUALITY_OPS(r0, r1, false);
    BOBUI_TEST_EQUALITY_OPS(r0, c0, true);
    BOBUI_TEST_EQUALITY_OPS(c0, r1, false);
    BOBUI_TEST_EQUALITY_OPS(a0, c0, true);
    BOBUI_TEST_EQUALITY_OPS(a0, r1, false);

#undef CHECK
#undef CHECK_IMPL
}

void tst_BobUIJson::testObjectIteration()
{
    QJsonObject object;
    ...
    for (QJsonObject::iterator it = object.begin(); it != object.end(); ++it) {
        ...
        BOBUI_TEST_EQUALITY_OPS(it, QJsonObject::iterator(), false);
    }

    {
        QJsonObject object2 = object;
        QCOMPARE(object, object2);
        BOBUI_TEST_EQUALITY_OPS(object, object2, true);
        ...
        BOBUI_TEST_EQUALITY_OPS(next, object2.begin(), true);
...

    {
        ...
        it += 5;
        BOBUI_TEST_ALL_COMPARISON_OPS(it, object.begin(), BobUI::strong_ordering::greater);
...

    {
        ...
        QCOMPARE(QJsonValue(it.value()).toDouble(), 5.);
        it -= 3;
        BOBUI_TEST_ALL_COMPARISON_OPS(object.constBegin(), it, BobUI::strong_ordering::less);
        QCOMPARE(QJsonValue(it.value()).toDouble(), 2.);
        QJsonObject::ConstIterator it2 = it + 5;
        BOBUI_TEST_EQUALITY_OPS(it, it2, false);
        QCOMPARE(QJsonValue(it2.value()).toDouble(), 7.);
        it2 = it - 1;
        BOBUI_TEST_ALL_COMPARISON_OPS(it2, it, BobUI::strong_ordering::less);
        BOBUI_TEST_ALL_COMPARISON_OPS(it2, it - 2, BobUI::strong_ordering::greater);
        QCOMPARE(QJsonValue(it2.value()).toDouble(), 1.);
    }
    ...
    BOBUI_TEST_ALL_COMPARISON_OPS(it, object.end(), BobUI::strong_ordering::equal);
    BOBUI_TEST_ALL_COMPARISON_OPS(it, object.constEnd(), BobUI::strong_ordering::equal);
    BOBUI_TEST_ALL_COMPARISON_OPS(it, object.begin(),
                               BobUI::strong_ordering::equal); // because object is empty
    BOBUI_TEST_ALL_COMPARISON_OPS(it, object.constBegin(), BobUI::strong_ordering::equal);
    BOBUI_TEST_ALL_COMPARISON_OPS(QJsonObject::Iterator(),
                               QJsonObject::Iterator(), BobUI::strong_ordering::equal);
    BOBUI_TEST_ALL_COMPARISON_OPS(QJsonObject::ConstIterator(),
                               QJsonObject::Iterator(), BobUI::strong_ordering::equal);
    BOBUI_TEST_ALL_COMPARISON_OPS(QJsonObject::ConstIterator(),
                               QJsonObject::ConstIterator(), BobUI::strong_ordering::equal);
}

void tst_BobUIJson::testArrayIteration()
{
    QJsonArray array;
    for (int i = 0; i < 10; ++i)
        array.append(i);
    ...
    for (QJsonArray::iterator it = array.begin(); it != array.end(); ++it, ++i) {
        ...
        BOBUI_TEST_EQUALITY_OPS(QJsonArray::iterator(), QJsonArray::iterator(), true);
        BOBUI_TEST_EQUALITY_OPS(QJsonArray::iterator(), it, false);
        BOBUI_TEST_EQUALITY_OPS(it1, it, true);
    }
...

    {
        ...
        BOBUI_TEST_EQUALITY_OPS(it, it2, false);
        it = array.begin();
        BOBUI_TEST_EQUALITY_OPS(it, array.begin(), true);
        it2 = it + 5;
        BOBUI_TEST_ALL_COMPARISON_OPS(it2, it,  BobUI::strong_ordering::greater);
        it += 5;
        BOBUI_TEST_EQUALITY_OPS(it, it2, true);
    }
    ...
    BOBUI_TEST_EQUALITY_OPS(it, array.end(), true);

    {
        ...
        for (QJsonArray::const_iterator it = array.constBegin();
            ...
            BOBUI_TEST_EQUALITY_OPS(QJsonArray::const_iterator(), QJsonArray::const_iterator(), true);
            BOBUI_TEST_EQUALITY_OPS(QJsonArray::const_iterator(), it, false);
            BOBUI_TEST_EQUALITY_OPS(it1, it, true);
        }
    }

    {
        ...
        BOBUI_TEST_EQUALITY_OPS(nonConstIt, it, true);
        it+=1;
        BOBUI_TEST_ALL_COMPARISON_OPS(nonConstIt, it, BobUI::strong_ordering::less);
    }
}

void tst_BobUIJson::testObjectFind()
{
    QJsonObject object;
    for (int i = 0; i < 10; ++i)
...
void tst_BobUIJson::testDocument()
{
    QJsonDocument doc;
    ...
    BOBUI_TEST_EQUALITY_OPS(doc2, doc3, true);
}

void tst_BobUIJson::nullValues()
{
    QJsonArray array;
    array.append(QJsonValue());
...
void tst_BobUIJson::constNullObject()
{
...
void tst_BobUIJson::keySorting_data()
{
    BOBUIest::addColumn<QString>("json");
    BOBUIest::addColumn<QStringList>("sortedKeys");

    QStringList list = {"A", "B"};
    BOBUIest::newRow("sorted-ascii-2") << R"({ "A": false, "B": true })" << list;
    const char *json = "{ \"B\": true, \"A\": false }";
    BOBUIest::newRow("unsorted-ascii-2") << json << list;

    list = QStringList{"A", "B", "C", "D", "E"};
    BOBUIest::newRow("sorted-ascii-5") << R"({"A": 1, "B": 2, "C": 3, "D": 4, "E": 5})" << list;
    BOBUIest::newRow("unsorted-ascii-5") << R"({"A": 1, "C": 3, "D": 4, "B": 2, "E": 5})" << list;
    BOBUIest::newRow("inverse-sorted-ascii-5") << R"({"E": 5, "D": 4, "C": 3, "B": 2, "A": 1})" << list;

    list = QStringList{"á", "é", "í", "ó", "ú"};
    BOBUIest::newRow("sorted-latin1") << R"({"á": 1, "é": 2, "í": 3, "ó": 4, "ú": 5})" << list;
    BOBUIest::newRow("unsorted-latin1") << R"({"á": 1, "í": 3, "ó": 4, "é": 2, "ú": 5})" << list;
    BOBUIest::newRow("inverse-sorted-latin1") << R"({"ú": 5, "ó": 4, "í": 3, "é": 2, "á": 1})" << list;

    BOBUIest::newRow("sorted-escaped-latin1") << R"({"\u00e1": 1, "\u00e9": 2, "\u00ed": 3, "\u00f3": 4, "\u00fa": 5})" << list;
    BOBUIest::newRow("unsorted-escaped-latin1") << R"({"\u00e1": 1, "\u00ed": 3, "\u00f3": 4, "\u00e9": 2, "\u00fa": 5})" << list;
    BOBUIest::newRow("inverse-sorted-escaped-latin1") << R"({"\u00fa": 5, "\u00f3": 4, "\u00ed": 3, "\u00e9": 2, "\u00e1": 1})" << list;

    list = QStringList{"A", "α", "Я", "€", "测"};
    BOBUIest::newRow("sorted") << R"({"A": 1, "α": 2, "Я": 3, "€": 4, "测": 5})" << list;
    BOBUIest::newRow("unsorted") << R"({"A": 1, "Я": 3, "€": 4, "α": 2, "测": 5})" << list;
    BOBUIest::newRow("inverse-sorted") << R"({"测": 5, "€": 4, "Я": 3, "α": 2, "A": 1})" << list;

    BOBUIest::newRow("sorted-escaped") << R"({"A": 1, "\u03b1": 2, "\u042f": 3, "\u20ac": 4, "\u6d4b": 5})" << list;
    BOBUIest::newRow("unsorted-escaped") << R"({"A": 1, "\u042f": 3, "\u20ac": 4, "\u03b1": 2, "\u6d4b": 5})" << list;
    BOBUIest::newRow("inverse-sorted-escaped") << R"({"\u6d4b": 5, "\u20ac": 4, "\u042f": 3, "\u03b1": 2, "A": 1})" << list;
}

void tst_BobUIJson::keySorting()
{
    QFETCH(QString, json);
...
void tst_BobUIJson::undefinedValues()
{
    QJsonObject object;
...
void tst_BobUIJson::fromVariant_data()
{
    BOBUIest::addColumn<QVariant>("variant");
    BOBUIest::addColumn<QJsonValue>("jsonvalue");
    ...
    BOBUIest::newRow("default") << QVariant() <<  QJsonValue();
    BOBUIest::newRow("nullptr") << QVariant::fromValue(nullptr) <<  QJsonValue(QJsonValue::Null);
    BOBUIest::newRow("bool") << QVariant(boolValue) <<  QJsonValue(boolValue);
    BOBUIest::newRow("int") << QVariant(intValue) <<  QJsonValue(intValue);
    BOBUIest::newRow("uint") << QVariant(uintValue) <<  QJsonValue(static_cast<qint64>(uintValue));
    BOBUIest::newRow("long") << QVariant::fromValue(longValue) <<  QJsonValue(static_cast<qint64>(longValue));
    BOBUIest::newRow("ulong") << QVariant::fromValue(ulongValue) <<  QJsonValue(static_cast<qint64>(ulongValue));
    BOBUIest::newRow("longlong") << QVariant(longlongValue) <<  QJsonValue(longlongValue);
    BOBUIest::newRow("ulonglong") << QVariant(ulonglongValue) <<  QJsonValue(static_cast<double>(ulonglongValue));
    BOBUIest::newRow("float16") << QVariant::fromValue(float16Value) <<  QJsonValue(float(float16Value));
    BOBUIest::newRow("float") << QVariant(floatValue) <<  QJsonValue(floatValue);
    BOBUIest::newRow("double") << QVariant(doubleValue) <<  QJsonValue(doubleValue);
    BOBUIest::newRow("string") << QVariant(stringValue) <<  QJsonValue(stringValue);
    BOBUIest::newRow("stringList") << QVariant(stringList) <<  QJsonValue(jsonArray_string);
    BOBUIest::newRow("variantList") << QVariant(variantList) <<  QJsonValue(jsonArray_variant);
    BOBUIest::newRow("variantMap") << QVariant(variantMap) <<  QJsonValue(jsonObject);
    BOBUIest::newRow("variantHash") << QVariant(variantHash) <<  QJsonValue(jsonObject);
}
...
void tst_BobUIJson::fromVariant()
{
...
void tst_BobUIJson::fromVariantSpecial_data()
{
    BOBUIest::addColumn<QVariant>("variant");
    BOBUIest::addColumn<QJsonValue>("jsonvalue");

    // BobUI types with special encoding
    BOBUIest::newRow("url") << QVariant(QUrl("https://example.com/\xc2\xa9 "))
                         << QJsonValue("https://example.com/%C2%A9%20");
    BOBUIest::newRow("uuid") << QVariant(QUuid(0x40c01df6, 0x1ad5, 0x4762, 0x9c, 0xfe, 0xfd, 0xba, 0xfa, 0xb5, 0xde, 0xf8))
                          << QJsonValue("40c01df6-1ad5-4762-9cfe-fdbafab5def8");
}

void tst_BobUIJson::fromVariantSpecial()
{
    QFETCH( QVariant, variant );
    QFETCH( QJsonValue, jsonvalue );
...
void tst_BobUIJson::toVariant_data()
{
    fromVariant_data();
}

void tst_BobUIJson::toVariant()
{
    QFETCH( QVariant, variant );
    QFETCH( QJsonValue, jsonvalue );
...
void tst_BobUIJson::fromVariantMap()
{
    QVariantMap map;
...
void tst_BobUIJson::fromVariantHash()
{
    QVariantHash map;
    map.insert(QLatin1String("key1"), QLatin1String("value1"));
    map.insert(QLatin1String("key2"), QLatin1String("value2"));
...
void tst_BobUIJson::toVariantMap()
{
    QCOMPARE(QMetaType::Type(QJsonValue(QJsonObject()).toVariant().typeId()),
             QMetaType::QVariantMap); // BOBUIBUG-32524
...
void tst_BobUIJson::toVariantHash()
{
    QJsonObject object;
...
void tst_BobUIJson::toVariantList()
{
    QCOMPARE(QMetaType::Type(QJsonValue(QJsonArray()).toVariant().typeId()),
             QMetaType::QVariantList); // BOBUIBUG-32524
...
void tst_BobUIJson::toJsonSillyNumericValues()
{
    QJsonObject object;
    QJsonArray array;
...
void tst_BobUIJson::toJsonLargeNumericValues()
{
    QJsonObject object;
    QJsonArray array;
    array.append(QJsonValue(1.234567)); // actual precision bug in BobUI 5.0.0
...
#ifdef BOBUI_NO_DOUBLECONVERSION // "shortest" double conversion is not very short then
...
void tst_BobUIJson::toJsonDenormalValues()
{
    BOBUI_IGNORE_DEPRECATIONS(constexpr bool has_denorm = std::numeric_limits<double>::has_denorm == std::denorm_present;)
    if constexpr (has_denorm) {
        QJsonObject object;
...
void tst_BobUIJson::toJsonTopLevel_data()
{
    BOBUIest::addColumn<QJsonValue>("value");
    BOBUIest::addColumn<QByteArray>("result");

    BOBUIest::addRow("undefined") << QJsonValue() << QByteArray("null");
    BOBUIest::addRow("null") << QJsonValue(QJsonValue::Null) << QByteArray("null");
    BOBUIest::addRow("true") << QJsonValue(true) << QByteArray("true");
    BOBUIest::addRow("false") << QJsonValue(false) << QByteArray("false");
    BOBUIest::addRow("integer") << QJsonValue(42) << QByteArray("42");
    BOBUIest::addRow("float") << QJsonValue(42.1) << QByteArray("42.1");
    BOBUIest::addRow("string") << QJsonValue("a string") << QByteArray("\"a string\"");
    BOBUIest::addRow("string with escapes")
            << QJsonValue("some \"escapes\"\t\n") << QByteArray(R"("some \"escapes\"\t\n")");
    BOBUIest::addRow("large number") << QJsonValue(18446744073709551616.0)
                                  << QByteArray("18446744073709552000");
}

void tst_BobUIJson::toJsonTopLevel()
{
...
void tst_BobUIJson::fromJsonErrors()
{
    {
...
void tst_BobUIJson::parseNumbers()
{
    {
        // test number parsing
        struct Numbers {
...
void tst_BobUIJson::parseStrings()
{
    const char *strings [] =
    {
        "Foo",
...
void tst_BobUIJson::parseDuplicateKeys()
{
...
void tst_BobUIJson::parseTopLevel_data()
{
    BOBUIest::addColumn<QByteArrayView>("input");
    BOBUIest::addColumn<QJsonValue>("result");

    BOBUIest::addRow("true") << QByteArrayView(" true ") << QJsonValue(true);
    BOBUIest::addRow("false") << QByteArrayView("false") << QJsonValue(false);
    BOBUIest::addRow("null") << QByteArrayView("null") << QJsonValue(QJsonValue::Null);
    BOBUIest::addRow("integer") << QByteArrayView(" 42 ") << QJsonValue(42);
    BOBUIest::addRow("string") << QByteArrayView(" \" a string \" ") << QJsonValue(" a string ");
    BOBUIest::addRow("garbage object after") << QByteArrayView("true{{{{", 4) << QJsonValue(true);
    BOBUIest::addRow("garbage 'e' after (true)") << QByteArrayView("truee", 4) << QJsonValue(true);
    BOBUIest::addRow("garbage 'e' after (false)") << QByteArrayView("falsee", 5) << QJsonValue(false);
    BOBUIest::addRow("garbage 'l' after (null)")
            << QByteArrayView("nulll", 4) << QJsonValue(QJsonValue::Null);
    BOBUIest::addRow("too large integer")
            << QByteArrayView("18446744073709551616") << QJsonValue(18446744073709551616.0);
    BOBUIest::addRow("too large integer (lower precision)")
            << QByteArrayView("18446744073709551616") << QJsonValue(18446744073709552000.0);
}

void tst_BobUIJson::parseTopLevel()
{
...
void tst_BobUIJson::parseTopLevelErrors_data()
{
    BOBUIest::addColumn<QByteArrayView>("input");
    BOBUIest::addColumn<QJsonParseError::ParseError>("parseError");
    BOBUIest::addColumn<int>("offset");

    BOBUIest::addRow("bad true") << QByteArrayView("truee") << QJsonParseError::GarbageAtEnd << 4;
    BOBUIest::addRow("bad false") << QByteArrayView("falsee") << QJsonParseError::GarbageAtEnd << 5;
    BOBUIest::addRow("bad null") << QByteArrayView("nulll") << QJsonParseError::GarbageAtEnd << 4;
    BOBUIest::addRow("duplicate number")
            << QByteArrayView(" 42 42 ") << QJsonParseError::GarbageAtEnd << 4;
    BOBUIest::addRow("unterminated string")
            << QByteArrayView(" \" a string ") << QJsonParseError::UnterminatedString << 13;
    BOBUIest::addRow("duplicate quotes")
            << QByteArrayView(" \" a \"\" ") << QJsonParseError::GarbageAtEnd << 6;
    BOBUIest::addRow("short true") << QByteArrayView("true", 3) << QJsonParseError::IllegalValue << 1;
    BOBUIest::addRow("short false") << QByteArrayView("false", 4) << QJsonParseError::IllegalValue
                                 << 1;
    BOBUIest::addRow("short null") << QByteArrayView("null", 3) << QJsonParseError::IllegalValue << 1;
    BOBUIest::addRow("empty string") << QByteArrayView("") << QJsonParseError::IllegalValue << 0;
    BOBUIest::addRow("only whitespace")
            << QByteArrayView("  \t \n \t\t \n \r\r \r\n ") << QJsonParseError::IllegalValue << 17;
}

void tst_BobUIJson::parseTopLevelErrors()
{
    QFETCH(QByteArrayView, input);
...
void tst_BobUIJson::assignToDocument()
{
    {
...
void tst_BobUIJson::testDuplicateKeys()
{
    QJsonObject obj;
...
void tst_BobUIJson::testCompaction()
{
    ...
    BOBUI_TEST_EQUALITY_OPS(obj, obj2, false);
    BOBUI_TEST_EQUALITY_OPS(QJsonObject(), obj2, true);
    obj2 = obj;
    BOBUI_TEST_EQUALITY_OPS(obj, obj2, true);
}

void tst_BobUIJson::testDebugStream()
{
    {
        // QJsonObject

        QJsonObject object;
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonObject()");
        qDebug() << object;

        object.insert(QLatin1String("foo"), QLatin1String("bar"));
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonObject({\"foo\":\"bar\"})");
        qDebug() << object;
    }

    {
        ...
        QJsonArray array;
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonArray()");
        qDebug() << array;

        array.append(1);
        array.append(QLatin1String("foo"));
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonArray([1,\"foo\"])");
        qDebug() << array;
    }

    {
        ...
        QJsonDocument doc;
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonDocument()");
        qDebug() << doc;

        QJsonObject object;
        object.insert(QLatin1String("foo"), QLatin1String("bar"));
        doc.setObject(object);
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonDocument({\"foo\":\"bar\"})");
        qDebug() << doc;

        QJsonArray array;
        array.append(1);
        array.append(QLatin1String("foo"));
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonDocument([1,\"foo\"])");
        doc.setArray(array);
        qDebug() << doc;
    }

    {
        ...
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonValue(null)");
        qDebug() << value;

        value = QJsonValue(true); // bool
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonValue(bool, true)");
        qDebug() << value;

        value = QJsonValue((double)4.2); // double
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonValue(double, 4.2)");
        qDebug() << value;

        value = QJsonValue((int)42); // int
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonValue(double, 42)");
        qDebug() << value;

        value = QJsonValue(QLatin1String("foo")); // string
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonValue(string, \"foo\")");
        qDebug() << value;
        ...
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonValue(array, QJsonArray([1,\"foo\"]))");
        qDebug() << value;

        QJsonObject object;
        object.insert(QLatin1String("foo"), QLatin1String("bar"));
        value = QJsonValue(object); // object
        BOBUIest::ignoreMessage(BobUIDebugMsg, "QJsonValue(object, QJsonObject({\"foo\":\"bar\"}))");
        qDebug() << value;
    }
}
...
void tst_BobUIJson::parseEscapes_data()
{
    BOBUIest::addColumn<QByteArray>("json");
    BOBUIest::addColumn<QByteArray>("jsonString");
    ...
    auto addUnicodeRow = [](char32_t u) {
        ...
        BOBUIest::addRow("U+%04X", u) << "[\"" + QByteArray(buf) + "\"]" << '"' + QByteArray(buf) + '"' << result;
    };
    ...
    auto makeSingleCharEscapeRow = [&](const char *format, char c, const QString &result,
        ...
        BOBUIest::addRow(format, formatArgs...) << json << jsonStr << result;
    };
...
void tst_BobUIJson::parseEscapes()
{
...
void tst_BobUIJson::makeEscapes_data()
{
    ...
    auto addUnicodeRow = [](char16_t c) {
        ...
        BOBUIest::addRow("U+%04X", c) << QString(c) << QByteArray(buf);
    };


    BOBUIest::addRow("quote") << "\"" << QByteArray(R"(\")");
    BOBUIest::addRow("backslash") << "\\" << QByteArray(R"(\\)");
    //BOBUIest::addRow("slash") << "/" << QByteArray(R"(\/)");    // does not get escaped
    BOBUIest::addRow("backspace") << "\b" << QByteArray(R"(\b)");
    BOBUIest::addRow("form-feed") << "\f" << QByteArray(R"(\f)");
    BOBUIest::addRow("newline") << "\n" << QByteArray(R"(\n)");
    BOBUIest::addRow("carriage-return") << "\r" << QByteArray(R"(\r)");
    BOBUIest::addRow("tab") << "\t" << QByteArray(R"(\t)");
    ...
    BOBUIest::addRow("inverted-surrogates") << improperlyPaired << QByteArray("\\udc00\\ud800");
}

void tst_BobUIJson::makeEscapes()
{
...
void tst_BobUIJson::assignObjects()
{
    const char *json =
            "[ { \"Key\": 1 }, { \"Key\": 2 } ]";
...
void tst_BobUIJson::assignArrays()
{
    const char *json =
            "[ [ 1 ], [ 2 ] ]";
...
void tst_BobUIJson::testTrailingComma()
{
...
void tst_BobUIJson::testDetachBug()
{
    QJsonObject dynamic;
...
void tst_BobUIJson::valueEquals()
{
    QCOMPARE(QJsonValue(), QJsonValue());
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(), QJsonValue(QJsonValue::Undefined), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(), QJsonValue(true), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(), QJsonValue(1.), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(), QJsonValue(QJsonArray()), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(), QJsonValue(QJsonObject()), false);

    QCOMPARE(QJsonValue(true), QJsonValue(true));
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(true), QJsonValue(false), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(true), QJsonValue(QJsonValue::Undefined), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(true), QJsonValue(), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(true), QJsonValue(1.), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(true), QJsonValue(QJsonArray()), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(true), QJsonValue(QJsonObject()), false);

    QCOMPARE(QJsonValue(1), QJsonValue(1));
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(1), QJsonValue(2), false);
    QCOMPARE(QJsonValue(1), QJsonValue(1.));
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(1), QJsonValue(1.1), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(1), QJsonValue(QJsonValue::Undefined), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(1), QJsonValue(), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(1), QJsonValue(true), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(1), QJsonValue(QJsonArray()), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(1), QJsonValue(QJsonObject()), false);
    ...
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonArray()), nonEmptyArray, false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonArray()), QJsonValue(QJsonValue::Undefined), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonArray()), QJsonValue(), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonArray()), QJsonValue(true), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonArray()), QJsonValue(1.), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonArray()), QJsonValue(QJsonObject()), false);

    QCOMPARE(QJsonValue(QJsonObject()), QJsonValue(QJsonObject()));
    QJsonObject nonEmptyObject;
    nonEmptyObject.insert("Key", true);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonObject()), nonEmptyObject, false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonObject()), QJsonValue(QJsonValue::Undefined), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonObject()), QJsonValue(), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonObject()), QJsonValue(true), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonObject()), QJsonValue(1.), false);
    BOBUI_TEST_EQUALITY_OPS(QJsonValue(QJsonObject()), QJsonValue(QJsonArray()), false);
...
void tst_BobUIJson::objectEquals_data()
{
    BOBUIest::addColumn<QJsonObject>("left");
    BOBUIest::addColumn<QJsonObject>("right");
    BOBUIest::addColumn<bool>("result");

    BOBUIest::newRow("two defaults") << QJsonObject() << QJsonObject() << true;
    ...
    BOBUIest::newRow("the same object (1 vs 2)") << object1 << object2 << true;
    BOBUIest::newRow("the same object (3 vs 3)") << object3 << object3 << true;
    BOBUIest::newRow("different objects (2 vs 3)") << object2 << object3 << false;
    BOBUIest::newRow("object vs default") << object1 << QJsonObject() << false;

    QJsonObject empty;
    empty.insert("property", 1);
    empty.take("property");
    BOBUIest::newRow("default vs empty") << QJsonObject() << empty << true;
    BOBUIest::newRow("empty vs empty") << empty << empty << true;
    BOBUIest::newRow("object vs empty") << object1 << empty << false;

    QJsonObject referencedEmpty;
    referencedEmpty["undefined"];
    BOBUIest::newRow("referenced empty vs referenced empty") << referencedEmpty << referencedEmpty << true;
    BOBUIest::newRow("referenced empty vs object") << referencedEmpty << object1 << false;
    ...
    BOBUIest::newRow("referenced object vs default") << referencedObject1 << QJsonObject() << false;
    BOBUIest::newRow("referenced object vs referenced object") << referencedObject1 << referencedObject1 << true;
    BOBUIest::newRow("referenced object vs object (different)") << referencedObject1 << object3 << false;
}

void tst_BobUIJson::objectEquals()
{
...
void tst_BobUIJson::arrayEquals_data()
{
    BOBUIest::addColumn<QJsonArray>("left");
    BOBUIest::addColumn<QJsonArray>("right");
    BOBUIest::addColumn<bool>("result");

    BOBUIest::newRow("two defaults") << QJsonArray() << QJsonArray() << true;
    ...
    BOBUIest::newRow("the same array (1 vs 2)") << array1 << array2 << true;
    BOBUIest::newRow("the same array (3 vs 3)") << array3 << array3 << true;
    BOBUIest::newRow("different arrays (2 vs 3)") << array2 << array3 << false;
    BOBUIest::newRow("array vs default") << array1 << QJsonArray() << false;

    QJsonArray empty;
    empty.append(1);
    empty.takeAt(0);
    BOBUIest::newRow("default vs empty") << QJsonArray() << empty << true;
    BOBUIest::newRow("empty vs default") << empty << QJsonArray() << true;
    BOBUIest::newRow("empty vs empty") << empty << empty << true;
    BOBUIest::newRow("array vs empty") << array1 << empty << false;
}

void tst_BobUIJson::arrayEquals()
{
...
void tst_BobUIJson::documentEquals_data()
{
    BOBUIest::addColumn<QJsonDocument>("left");
    BOBUIest::addColumn<QJsonDocument>("right");
    BOBUIest::addColumn<bool>("result");

    BOBUIest::newRow("two defaults") << QJsonDocument() << QJsonDocument() << true;

    QJsonDocument emptyobj(QJsonObject{});
    QJsonDocument emptyarr(QJsonArray{});
    BOBUIest::newRow("emptyarray vs default") << emptyarr << QJsonDocument() << false;
    BOBUIest::newRow("emptyobject vs default") << emptyobj << QJsonDocument() << false;
    BOBUIest::newRow("emptyarray vs emptyobject") << emptyarr << emptyobj << false;

    QJsonDocument array1(QJsonArray{1});
    QJsonDocument array2(QJsonArray{2});
    BOBUIest::newRow("emptyarray vs emptyarray") << emptyarr << emptyarr << true;
    BOBUIest::newRow("emptyarray vs array") << emptyarr << array1 << false;
    BOBUIest::newRow("array vs array") << array1 << array1 << true;
    BOBUIest::newRow("array vs otherarray") << array1 << array2 << false;

    QJsonDocument object1(QJsonObject{{"hello", "world"}});
    QJsonDocument object2(QJsonObject{{"hello", 2}});
    BOBUIest::newRow("emptyobject vs emptyobject") << emptyobj << emptyobj << true;
    BOBUIest::newRow("emptyobject vs object") << emptyobj << object1 << false;
    BOBUIest::newRow("object vs object") << object1 << object1 << true;
    BOBUIest::newRow("object vs otherobject") << object1 << object2 << false;

    BOBUIest::newRow("object vs array") << array1 << object1 << false;
}

void tst_BobUIJson::documentEquals()
{
...
void tst_BobUIJson::nesting()
{
    ...
    BOBUIhread *thr = BOBUIhread::create(nesting_test);
...
void tst_BobUIJson::longStrings()
{
...
void tst_BobUIJson::testJsonValueRefDefault()
{
    QJsonObject empty;
...
void tst_BobUIJson::arrayInitializerList()
{
...
void tst_BobUIJson::objectInitializerList()
{
...
void tst_BobUIJson::unicodeKeys()
{
    QByteArray json = "{"
                      "\"x\\u2090_1\": \"hello_1\","
                      "\"y\\u2090_2\": \"hello_2\","
...
void tst_BobUIJson::garbageAtEnd()
{
    QJsonParseError error;
...
void tst_BobUIJson::removeNonLatinKey()
{
...
void tst_BobUIJson::documentFromVariant()
{
    ...
    BOBUI_TEST_EQUALITY_OPS(da1, da2, true);
    ...
    BOBUI_TEST_EQUALITY_OPS(do1, do2, true);
}

void tst_BobUIJson::parseErrorOffset_data()
{
    BOBUIest::addColumn<QByteArray>("json");
    BOBUIest::addColumn<int>("errorOffset");

    BOBUIest::newRow("Trailing comma in object") << QByteArray("{ \"value\": false, }") << 19;
    BOBUIest::newRow("Trailing comma in object plus whitespace") << QByteArray("{ \"value\": false, }    ") << 19;
    BOBUIest::newRow("Trailing comma in array") << QByteArray("[ false, ]") << 10;
    BOBUIest::newRow("Trailing comma in array plus whitespace") << QByteArray("[ false, ]    ") << 10;
    BOBUIest::newRow("Missing value in object") << QByteArray("{ \"value\": , } ") << 12;
    BOBUIest::newRow("Missing value in array") << QByteArray("[ \"value\" , , ] ") << 13;
    BOBUIest::newRow("Leading comma in object") << QByteArray("{ ,  \"value\": false}") << 3;
    BOBUIest::newRow("Leading comma in array") << QByteArray("[ ,  false]") << 3;
    BOBUIest::newRow("Stray ,") << QByteArray("  ,  ") << 3;
    BOBUIest::newRow("Stray [") << QByteArray("  [  ") << 5;
    BOBUIest::newRow("Stray }") << QByteArray("  }  ") << 3;
}

void tst_BobUIJson::parseErrorOffset()
{
    QFETCH(QByteArray, json);
...
void tst_BobUIJson::implicitValueType()
{
...
void tst_BobUIJson::implicitDocumentType()
{
...
void tst_BobUIJson::streamSerializationQJsonDocument_data()
{
    BOBUIest::addColumn<QJsonDocument>("document");
    BOBUIest::newRow("empty") << QJsonDocument();
    BOBUIest::newRow("object") << QJsonDocument(QJsonObject{{"value", 42}});
}

void tst_BobUIJson::streamSerializationQJsonDocument()
{
    ...
    BOBUI_TEST_EQUALITY_OPS(output, document, true);
}

void tst_BobUIJson::streamSerializationQJsonArray_data()
{
    BOBUIest::addColumn<QJsonArray>("array");
    BOBUIest::newRow("empty") << QJsonArray();
    BOBUIest::newRow("values") << QJsonArray{665, 666, 667};
}

void tst_BobUIJson::streamSerializationQJsonArray()
{
    // Check interface only, implementation is tested through to and from
    // json functions.
    QByteArray buffer;
...
void tst_BobUIJson::streamSerializationQJsonObject_data()
{
    BOBUIest::addColumn<QJsonObject>("object");
    BOBUIest::newRow("empty") << QJsonObject();
    BOBUIest::newRow("non-empty") << QJsonObject{{"foo", 665}, {"bar", 666}};
}

void tst_BobUIJson::streamSerializationQJsonObject()
{
    // Check interface only, implementation is tested through to and from
    // json functions.
    QByteArray buffer;
...
void tst_BobUIJson::streamSerializationQJsonValue_data()
{
    BOBUIest::addColumn<QJsonValue>("value");
    BOBUIest::newRow("double") << QJsonValue{665};
    BOBUIest::newRow("bool") << QJsonValue{true};
    BOBUIest::newRow("string") << QJsonValue{QStringLiteral("bum")};
    BOBUIest::newRow("array") << QJsonValue{QJsonArray{12,1,5,6,7}};
    BOBUIest::newRow("object") << QJsonValue{QJsonObject{{"foo", 665}, {"bar", 666}}};
    // test json escape sequence
    BOBUIest::newRow("array with 0xD800") << QJsonValue(QJsonArray{QString(QChar(0xD800))});
    BOBUIest::newRow("array with 0xDF06,0xD834") << QJsonValue(QJsonArray{QString(QChar(0xDF06)).append(QChar(0xD834))});
}

void tst_BobUIJson::streamSerializationQJsonValue()
{
    QByteArray buffer;
    QFETCH(QJsonValue, value);
    QJsonValue output;
...
void tst_BobUIJson::streamSerializationQJsonValueEmpty()
{
    QByteArray buffer;
    {
...
void tst_BobUIJson::streamVariantSerialization()
{
    // Check interface only, implementation is tested through to and from
    // json functions.
    QByteArray buffer;
...
void tst_BobUIJson::escapeSurrogateCodePoints_data()
{
    BOBUIest::addColumn<QString>("str");
    BOBUIest::addColumn<QByteArray>("escStr");
    BOBUIest::newRow("0xD800") << QString(QChar(0xD800)) << QByteArray("\\ud800");
    BOBUIest::newRow("0xDF06,0xD834") << QString(QChar(0xDF06)).append(QChar(0xD834)) << QByteArray("\\udf06\\ud834");
}

void tst_BobUIJson::escapeSurrogateCodePoints()
{
    QFETCH(QString, str);
...
void tst_BobUIJson::fromToVariantConversions_data()
{
    BOBUIest::addColumn<QVariant>("variant");
    BOBUIest::addColumn<QJsonValue>("json");
    BOBUIest::addColumn<QVariant>("jsonToVariant");
    ...
    BOBUIest::newRow("default")     << QVariant() << QJsonValue(QJsonValue::Null)
                                 << QVariant::fromValue(nullptr);
    BOBUIest::newRow("nullptr")     << QVariant::fromValue(nullptr) << QJsonValue(QJsonValue::Null)
                                 << QVariant::fromValue(nullptr);
    BOBUIest::newRow("bool")        << QVariant(true) << QJsonValue(true) << QVariant(true);
    BOBUIest::newRow("int pos")     << QVariant(123) << QJsonValue(123) << QVariant(qlonglong(123));
    BOBUIest::newRow("int neg")     << QVariant(-123) << QJsonValue(-123) << QVariant(qlonglong(-123));
    BOBUIest::newRow("int big pos") << QVariant((1ll << 55) +1) << QJsonValue((1ll << 55) + 1)
                                 << QVariant(qlonglong((1ll << 55) + 1));
    BOBUIest::newRow("int big neg") << QVariant(-(1ll << 55) + 1) << QJsonValue(-(1ll << 55) + 1)
                                 << QVariant(qlonglong(-(1ll << 55) + 1));
    BOBUIest::newRow("int max")     << QVariant(maxInt) << QJsonValue(maxInt) << QVariant(maxInt);
    BOBUIest::newRow("int min")     << QVariant(minInt) << QJsonValue(minInt) << QVariant(minInt);
    BOBUIest::newRow("double pos")  << QVariant(123.) << QJsonValue(123.) << QVariant(qlonglong(123.));
    BOBUIest::newRow("double neg")  << QVariant(-123.) << QJsonValue(-123.)
                                 << QVariant(qlonglong(-123.));
    BOBUIest::newRow("double big")  << QVariant(maxDouble - 1000) << QJsonValue(maxDouble - 1000)
                                 << QVariant(maxDouble - 1000);
    BOBUIest::newRow("double max")  << QVariant(maxDouble) << QJsonValue(maxDouble)
                                 << QVariant(maxDouble);
    BOBUIest::newRow("double min")  << QVariant(minDouble) << QJsonValue(minDouble)
                                 << QVariant(minDouble);
    BOBUIest::newRow("double big neg")  << QVariant(1000 - maxDouble) << QJsonValue(1000 - maxDouble)
                                     << QVariant(1000 - maxDouble);
    BOBUIest::newRow("double max neg")  << QVariant(-maxDouble) << QJsonValue(-maxDouble)
                                     << QVariant(-maxDouble);
    BOBUIest::newRow("double min neg")  << QVariant(-minDouble) << QJsonValue(-minDouble)
                                     << QVariant(-minDouble);

    BOBUIest::newRow("string null")     << QVariant(QString()) << QJsonValue(QString())
                                     << QVariant(QString());
    BOBUIest::newRow("string empty")    << QVariant(QString("")) << QJsonValue(QString(""))
                                     << QVariant(QString(""));
    BOBUIest::newRow("string ascii")    << QVariant(QString("Data")) << QJsonValue(QString("Data"))
                                     << QVariant(QString("Data"));
    BOBUIest::newRow("string utf8")     << QVariant(QString(utf8)) << QJsonValue(QString(utf8))
                                     << QVariant(QString(utf8));

    BOBUIest::newRow("bytearray null")  << QVariant(QByteArray()) << QJsonValue(QJsonValue::Null)
                                     << QVariant::fromValue(nullptr);
    BOBUIest::newRow("bytearray empty") << QVariant(QByteArray()) << QJsonValue(QJsonValue::Null)
                                     << QVariant::fromValue(nullptr);
    BOBUIest::newRow("bytearray ascii") << QVariant(QByteArray("Data")) << QJsonValue(QString("Data"))
                                     << QVariant(QString("Data"));
    BOBUIest::newRow("bytearray utf8")  << QVariant(utf8) << QJsonValue(QString(utf8))
                                     << QVariant(QString(utf8));

    BOBUIest::newRow("datetime") << QVariant(dt) << QJsonValue(dt.toString(BobUI::ISODateWithMs))
                              << QVariant(dt.toString(BobUI::ISODateWithMs));
    BOBUIest::newRow("url")      << QVariant(QUrl("http://example.com/{q}"))
                              << QJsonValue("http://example.com/%7Bq%7D")
                              << QVariant(QString("http://example.com/%7Bq%7D"));
    BOBUIest::newRow("uuid")     << QVariant(QUuid(uuid))
                              << QJsonValue(uuid.toString(QUuid::WithoutBraces))
                              << QVariant(uuid.toString(QUuid::WithoutBraces));
    BOBUIest::newRow("regexp")   << QVariant(QRegularExpression(".")) << QJsonValue(QJsonValue::Null)
                              << QVariant::fromValue(nullptr);

    BOBUIest::newRow("inf")      << QVariant(qInf()) << QJsonValue(QJsonValue::Null)
                              << QVariant::fromValue(nullptr);
    BOBUIest::newRow("-inf")     << QVariant(-qInf()) << QJsonValue(QJsonValue::Null)
                              << QVariant::fromValue(nullptr);
    BOBUIest::newRow("NaN")      << QVariant(qQNaN()) << QJsonValue(QJsonValue::Null)
                              << QVariant::fromValue(nullptr);
    ...
    BOBUIest::newRow("ulonglong") << QVariant(ulongValue) << QJsonValue(uLongToDouble)
                               << QVariant(uLongToDouble);
}

void tst_BobUIJson::fromToVariantConversions()
{
    QFETCH(QVariant, variant);
...
void tst_BobUIJson::testIteratorComparison()
{
...
void tst_BobUIJson::noLeakOnNameClash_data()
{
    BOBUIest::addColumn<QString>("fileName");
    BOBUIest::addColumn<QByteArray>("result");
    BOBUIest::addRow("simple")
            << QStringLiteral("simple.duplicates.json")
            << QByteArray(R"({"": 0})");
    BOBUIest::addRow("test")
...
void tst_BobUIJson::noLeakOnNameClash()
{
    ...
    BOBUI_TEST_EQUALITY_OPS(val, expected, true);
...
void tst_BobUIJson::objectItemsRange()
{
    auto makeObj = [] {
        return QJsonObject{
            { "a", 1 },
...
BOBUIEST_MAIN(tst_BobUIJson)
#include "tst_bobuijson.moc"
