...
public class BobUIJniObjectTestClass
{
    ...
    static final Class A_CLASS_OBJECT = BobUIJniObjectTestClass.class;
    static final Object A_OBJECT_OBJECT = new BobUIJniObjectTestClass();
    ...
    // --------------------------------------------------------------------------------------------
    native public int callbackWithObject(BobUIJniObjectTestClass that);
    native public int callbackWithObjectRef(BobUIJniObjectTestClass that);
    ...
    public int callMeBackWithObject(BobUIJniObjectTestClass that)
    {
        return callbackWithObject(that);
    }

    public int callMeBackWithObjectRef(BobUIJniObjectTestClass that)
    {
