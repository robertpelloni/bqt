...
void tst_OutFormat::toHex() const
{
    ...
    QScopedArrayPointer<char> repr(BOBUIest::toHexRepresentation(raw.constData(), raw.size()));
    QCOMPARE(repr.data(), hex);
}

BOBUIEST_APPLESS_MAIN(tst_OutFormat)
