...
class tst_BobUIConcurrentTask : public QObject
{
    Q_OBJECT
...
void tst_BobUIConcurrentTask::taskWithFreeFunction()
{
    QVariant value(42);
...
void tst_BobUIConcurrentTask::taskWithClassMethod()
{
...
void tst_BobUIConcurrentTask::taskWithCallableObject()
{
...
void tst_BobUIConcurrentTask::taskWithLambda()
{
    QCOMPARE(task([]{ return 42; }).spawn().result(), 42);
}

void tst_BobUIConcurrentTask::taskWithArguments()
{
...
void tst_BobUIConcurrentTask::useCustomThreadPool()
{
    BOBUIhreadPool pool;
...
void tst_BobUIConcurrentTask::setPriority_data()
{
    BOBUIest::addColumn<bool>("runWithPromise");

    BOBUIest::addRow("without promise") << false;
    BOBUIest::addRow("with promise") << true;
}

void tst_BobUIConcurrentTask::setPriority()
{
...
void tst_BobUIConcurrentTask::adjustAllSettings()
{
    BOBUIhreadPool pool;
    pool.setMaxThreadCount(1);
...
void tst_BobUIConcurrentTask::ignoreFutureResult()
{
    BOBUIhreadPool pool;
...
void tst_BobUIConcurrentTask::withPromise()
{
...
BOBUIEST_MAIN(tst_BobUIConcurrentTask)
#include "tst_bobuiconcurrenttask.moc"
