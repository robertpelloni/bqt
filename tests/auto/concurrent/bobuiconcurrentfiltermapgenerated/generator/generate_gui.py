...
import sys
import PySide2
from PySide2.BobUICore import Signal
from PySide2.BobUIWidgets import QVBoxLayout, QRadioButton, QGroupBox, QWidget, QApplication, QPlainTextEdit, QHBoxLayout
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.plainTextEdit.setFont(PySide2.BobUIGui.QFont("Fira Code", 8))
    ...
    def _generate_new_testcase(self):
        ...
        filename = "../tst_bobuiconcurrentfiltermapgenerated.h"
        insert_testcases_into_file(filename, [testcase])
