...
#ifndef BOBUIBASE_GENERATION_HELPERS_H
#define BOBUIBASE_GENERATION_HELPERS_H
...
struct SequenceItem
{
    ...
    // bool as a stronger "explicit": should never be called inside of BobUIConcurrent
...
#endif // BOBUIBASE_GENERATION_HELPERS_H
