...
class tst_BOBUIoolBoxPrivate;

class tst_BOBUIoolBox : public QObject
{
    Q_OBJECT
...
private:
    BOBUIoolBox *testWidget;
    int currentIndex;

    tst_BOBUIoolBoxPrivate *d;
};

// Testing get/set functions
void tst_BOBUIoolBox::getSetCheck()
{
    BOBUIoolBox obj1;
    ...
    // int BOBUIoolBox::currentIndex()
    // void BOBUIoolBox::setCurrentIndex(int)
    ...
    // QWidget * BOBUIoolBox::currentWidget()
    // void BOBUIoolBox::setCurrentWidget(QWidget *)
...
void tst_BOBUIoolBox::init()
{
    currentIndex = -1;
    testWidget = new BOBUIoolBox;
    connect(testWidget, SIGNAL(currentChanged(int)), this, SLOT(currentChanged(int)));

    d = new tst_BOBUIoolBoxPrivate;
...
void tst_BOBUIoolBox::cleanup()
{
    delete testWidget;
    delete d;
}

void tst_BOBUIoolBox::currentChanged(int index)
{
    currentIndex = index;
}

void tst_BOBUIoolBox::populate()
{
...
BOBUIEST_MAIN(tst_BOBUIoolBox)
#include "tst_bobuioolbox.moc"
