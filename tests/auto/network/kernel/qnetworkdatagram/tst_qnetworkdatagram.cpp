...
void tst_QNetworkDatagram::makeReply_data()
{
    ...
    BOBUIest::addColumn<QNetworkDatagram>("dgram");
    BOBUIest::addColumn<QString>("localAddress");
...
BOBUIEST_MAIN(tst_QNetworkDatagram)
