...
if(FORCE-CMP0156-NEW)
    set(BOBUI_FORCE_CMP0156_TO_VALUE NEW)
endif()

find_package(BobUI6 REQUIRED COMPONENTS Gui)

bobui_add_library(core_helper STATIC)
target_sources(core_helper PRIVATE core_helper.mm)
set_target_properties(core_helper PROPERTIES FRAMEWORK TRUE)

bobui_add_library(gui_helper STATIC)
...
bobui_add_executable(app)
target_sources(app PRIVATE main.cpp)
target_link_libraries(app PRIVATE BobUI6::Gui)
