...
set(find_package_opts "-DBobUI6_DIR=${BobUI6_DIR}")

run_cmake_with_options(bobui_internal_add_compiler_dependent_flags_pass ${find_package_opts})
# Failing cases
...
foreach(case IN ITEMS
    ...
    run_cmake_with_options(bobui_internal_add_compiler_dependent_flags_fail
