...
bobui_internal_add_compiler_dependent_flags(basic INTERFACE
    COMPILERS ALL
        OPTIONS -opt1
    COMPILERS GNU
        OPTIONS -opt2 -opt3
...
bobui_internal_add_compiler_dependent_flags(conditions INTERFACE
    COMPILERS ALL
            # No conditions
            OPTIONS -opt
        # Multiple conditions
...
bobui_internal_add_compiler_dependent_flags(conditions_stack INTERFACE
    COMPILERS ALL
...
bobui_internal_add_compiler_dependent_flags(one_language INTERFACE
    COMPILERS ALL
...
bobui_internal_add_compiler_dependent_flags(multiple_language INTERFACE
    COMPILERS ALL
        CONDITIONS VERSION_LESS 42
            OPTIONS -opt
    LANGUAGES C OBJCXX
...
bobui_internal_add_compiler_dependent_flags(common_condition INTERFACE
    COMPILERS ALL
            OPTIONS -opt
