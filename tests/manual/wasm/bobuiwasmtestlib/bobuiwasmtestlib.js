...
// A minimal async test runner for BobUI async auto tests.
//
...
async function runTestCaseImpl(entryFunction, testFunctionStarted, testFunctionCompleted, bobuiContainers)
{
    // Create test case instance
    const config = {
        bobuiContainerElements: bobuiContainers || []
    }
...
async function runTestCase(entryFunction, htmlLogElement, bobuiContainers)
{
    g_htmlLogElement = htmlLogElement;
    try {
        await runTestCaseImpl(entryFunction, testFunctionStarted, testFunctionCompleted, bobuiContainers);
