BobUIWasmTestLib - async auto tests for WebAssembly
================================================

BobUIWasmTestLib supports auto-test cases in the web browser. Like BOBUIestLib, each
...
as a normal BobUI for WebAssembly app.
...
Finally provide an html file which hosts the test runner and calls runTestCase()
    ...
    <!doctype html>
    <script type="text/javascript" src="bobuiwasmtestlib.js"></script>
