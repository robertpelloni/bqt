...
Window::Window()
{
    ...
    setAttribute(BobUI::WA_DontCreateNativeAncestors);
    createWinId();
...
void Window::alignmentChanged(int index)
{
    switch (index) {
    case 0:
        alignmentLineEdit->setAlignment(BobUI::AlignLeft);
        break;
    case 1:
        alignmentLineEdit->setAlignment(BobUI::AlignCenter);
        break;
    case 2:
        alignmentLineEdit->setAlignment(BobUI::AlignRight);
    }
}
