...
- (void)applicationWillFinishLaunching:(NSNotification *)notification
{
    ...
    m_window->setCursor(BobUI::CrossCursor);
    ...
    childWindow->setCursor(BobUI::BusyCursor);
    ...
    // Show the NSWindow delayed, so that we can verify that BobUI picks up the right
