...
void tst_QPainterPath::general_data()
{
    ...
    BOBUIest::newRow("Uncached") << false;
    BOBUIest::newRow("Cached") << true;
}
...
BOBUIEST_MAIN(tst_QPainterPath)
