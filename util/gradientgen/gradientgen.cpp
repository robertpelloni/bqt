...
int main()
{
    ...
    p.printLine("static QList<QGradientStop> bobui_preset_gradient_stops(QGradient::Preset preset)");
    p.printLine("{");
    {
        Printer::Indenter i(p);
    ...
    p.printLine("static constexpr QGradient::QGradientData bobui_preset_gradient_data[] = {");
    {
        Printer::Indenter i(p);
    ...
    p.printLine("static void *bobui_preset_gradient_dummy()");
    p.printLine("{");
    {
        Printer::Indenter i(p);
