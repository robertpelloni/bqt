...
def generate_mkcert_certificate(addresses):
    ...
    cert_file = tempfile.NamedTemporaryFile(
        mode="w+b", prefix="bobuiwasmserver-certificate-", suffix=".pem", delete=True
    )
    cert_key_file = tempfile.NamedTemporaryFile(
        mode="w+b", prefix="bobuiwasmserver-certificate-key-", suffix=".pem", delete=True
    )
...
def main():
    parser = argparse.ArgumentParser(
        description="A development web server for BobUI for WebAssembly applications.",
    ...
    print("BobUI for WebAssembly development server.\n")
