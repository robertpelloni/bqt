...
*/
class BobUIRootLayout extends BobUILayout
{
    BobUIRootLayout(Context context)
    {
        super(context);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh)
    {
        ...
        BobUIDisplayManager.handleLayoutSizeChanged(w, h);
    }
    ...
    public void onConfigurationChanged(Configuration configuration)
    {
        ...
        // called a bit late (BOBUIBUG-94459).
        BobUINative.runAction(() -> {
            BobUIDisplayManager.handleOrientationChange(activity);
        });
    }
}
