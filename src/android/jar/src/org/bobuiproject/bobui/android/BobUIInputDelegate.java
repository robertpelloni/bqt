...
class BobUIInputDelegate implements BobUIInputConnection.BobUIInputConnectionListener, BobUIInputInterface
{

    private static final String TAG = "BobUIInputDelegate";
    // keyboard methods
    ...
    private BobUIEditText m_currentEditText = null;
    ...
    BobUIInputDelegate(KeyboardVisibilityListener listener)
    {
    ...
    // BobUIInputInterface implementation begin
    @Override
                    ...
                    WindowInsetsAnimation.Callback.DISPATCH_MODE_CONTINUE_ON_SUBTREE) {
                        ...
                        public void onEnd(WindowInsetsAnimation animation) {
                            ...
                            if ((animation.getTypeMask() & WindowInsets.Type.ime()) == 0) {
                                BobUINativeInputConnection.updateCursorPosition();
                                     ...
                                     final int inputHints, final int enterKeyType)
    {
        ...
        BobUINative.runAction(() -> {
            ...
            m_currentEditText.setLayoutParams(new BobUILayout.LayoutParams(width, height, x, y));
    ...
    */
    ...
    @Override
    public BobUIInputConnection.BobUIInputConnectionListener getInputConnectionListener()
    {
        return this;
    }
    ...
    public void hideSoftwareKeyboard()
    {
        ...
        BobUINative.runAction(() -> {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                Activity activity = BobUINative.activity();
                if (activity == null) {
    ...
    // BobUIInputInterface implementation end

    // BobUIInputConnectionListener methods
    @Override
    ...
    public boolean isKeyboardHidden() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.R) {
            ...
            BobUIDisplayManager.getDisplay(activity).getMetrics(metrics);
    ...
    @Override
    public void onEditTextChanged(BobUIEditText editText) {
    ...
    BobUIEditText getCurrentBobUIEditText()
    {
    ...
    private void keyboardVisibilityUpdated(boolean visibility)
    {
        ...
        BobUIInputDelegate.keyboardVisibilityChanged(visibility);
    }
    ...
    void setFocusedView(BobUIEditText currentEditText)
    {
        setKeyboardTransitionInProgress(false);
    ...
    {
        if (m_currentEditText == null) {
            Log.w(TAG, "probeForKeyboardHeight: null BobUIEditText");
            return;
        }
        m_currentEditText.postDelayed(() -> {
    ...
    boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        if ((keyCode == KeyEvent.KEYCODE_VOLUME_UP
                ...
                && System.getenv("BOBUI_ANDROID_VOLUME_KEYS") == null) {
            return false;
        }
        ...
        BobUIInputDelegate.keyDown(keyCode, c, event.getMetaState(), event.getRepeatCount() > 0);
    ...
    boolean onKeyUp(int keyCode, KeyEvent event)
    {
        ...
        BobUIInputDelegate.keyUp(keyCode, event.getUnicodeChar(), event.getMetaState(), autoRepeat);
    ...
    static void sendTouchEvent(MotionEvent event, int id)
    {
        ...
        switch (event.getToolType(0)) {
            case MotionEvent.TOOL_TYPE_STYLUS:
                pointerType = 1; // BOBUIabletEvent::Pen
                break;
            case MotionEvent.TOOL_TYPE_ERASER:
                pointerType = 3; // BOBUIabletEvent::Eraser
                break;
        }
