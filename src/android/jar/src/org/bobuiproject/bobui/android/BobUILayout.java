...
class BobUILayout extends ViewGroup {

    BobUILayout(Context context)
    {
        super(context);
    }

    BobUILayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    }

    BobUILayout(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
                ...
                if (child.getLayoutParams() instanceof BobUILayout.LayoutParams) {
                    BobUILayout.LayoutParams lp
                            = (BobUILayout.LayoutParams) child.getLayoutParams();
    ...
    */
    ...
    {
        return p instanceof BobUILayout.LayoutParams;
    }
