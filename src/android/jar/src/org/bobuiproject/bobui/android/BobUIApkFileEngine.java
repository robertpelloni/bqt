...
@UsedFromNativeCode
class BobUIApkFileEngine {
    private final static String BobUITAG = BobUIApkFileEngine.class.getSimpleName();
    ...
    BobUIApkFileEngine(Context context)
    {
    ...
    boolean open(String fileName)
    {
        try {
            ...
            Log.e(BobUITAG, "Failed to open the app APK with " + e);
        }
    ...
    boolean close()
    {
        try {
            ...
            Log.e(BobUITAG, "Failed to close resources with " + e);
        }
    ...
    MappedByteBuffer getMappedByteBuffer(long offset, long size)
    {
        try {
            ...
            Log.e(BobUITAG, "Failed to map APK file to memory with " + e);
        }
    ...
    byte[] read(long maxlen)
    {
        ...
        try {
            ...
            Log.e(BobUITAG, "Failed to read content with " + e);
        }
    ...
    static String getAppApkFilePath()
    {
        ...
        try {
            ...
            if (applicationInfo.splitSourceDirs != null) {
                ...
                if (m_appApkPath == null)
                    Log.d(BobUITAG, "No ABI specific split APK found, defaulting to the main APK.");
            }

            if (m_appApkPath == null)
                m_appApkPath = applicationInfo.sourceDir;
        } catch (PackageManager.NameNotFoundException e) {
            Log.e(BobUITAG, "Failed to get the app APK path with " + e);
            return null;
        }
        return m_appApkPath;
    }
    ...
    static ArrayList<JFileInfo> getApkFileInfos(String apkPath)
    {
        ...
        try (ZipFile zipFile = new ZipFile(apkPath)) {
            ...
            Log.e(BobUITAG, "Failed to list App's APK files with " + e);
        }
