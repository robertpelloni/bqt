...
#define DELETE_BACKEND(X) \
        ...
        BOBUI_OPENGL_VERSIONS(DELETE_BACKEND)
...
#define CREATE_BACKEND(X) \
    case VERSION_ENUM(X): \
        ...
        break;
    BOBUI_OPENGL_VERSIONS(CREATE_BACKEND)
...
/*!
    ...
    BobUI now provides a family of classes which all inherit from
    ...
    BobUI provides classes for all version and Core and Compatibility profile
...
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_1_0_CoreBackend, BOBUI_OPENGL_1_0_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_1_1_CoreBackend, BOBUI_OPENGL_1_1_FUNCTIONS)

BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_1_2_CoreBackend, BOBUI_OPENGL_1_2_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_1_3_CoreBackend, BOBUI_OPENGL_1_3_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_1_4_CoreBackend, BOBUI_OPENGL_1_4_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_1_5_CoreBackend, BOBUI_OPENGL_1_5_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_2_0_CoreBackend, BOBUI_OPENGL_2_0_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_2_1_CoreBackend, BOBUI_OPENGL_2_1_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_3_0_CoreBackend, BOBUI_OPENGL_3_0_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_3_1_CoreBackend, BOBUI_OPENGL_3_1_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_3_2_CoreBackend, BOBUI_OPENGL_3_2_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_3_3_CoreBackend, BOBUI_OPENGL_3_3_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_4_0_CoreBackend, BOBUI_OPENGL_4_0_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_4_1_CoreBackend, BOBUI_OPENGL_4_1_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_4_2_CoreBackend, BOBUI_OPENGL_4_2_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_4_3_CoreBackend, BOBUI_OPENGL_4_3_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_4_4_CoreBackend, BOBUI_OPENGL_4_4_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_4_5_CoreBackend, BOBUI_OPENGL_4_5_FUNCTIONS)

BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_1_0_DeprecatedBackend, BOBUI_OPENGL_1_0_DEPRECATED_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_1_1_DeprecatedBackend, BOBUI_OPENGL_1_1_DEPRECATED_FUNCTIONS)

BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_1_2_DeprecatedBackend, BOBUI_OPENGL_1_2_DEPRECATED_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_1_3_DeprecatedBackend, BOBUI_OPENGL_1_3_DEPRECATED_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_1_4_DeprecatedBackend, BOBUI_OPENGL_1_4_DEPRECATED_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_2_0_DeprecatedBackend, BOBUI_OPENGL_2_0_DEPRECATED_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_3_0_DeprecatedBackend, BOBUI_OPENGL_3_0_DEPRECATED_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_3_3_DeprecatedBackend, BOBUI_OPENGL_3_3_DEPRECATED_FUNCTIONS)
BOBUI_OPENGL_IMPLEMENT(QOpenGLFunctions_4_5_DeprecatedBackend, BOBUI_OPENGL_4_5_DEPRECATED_FUNCTIONS)
