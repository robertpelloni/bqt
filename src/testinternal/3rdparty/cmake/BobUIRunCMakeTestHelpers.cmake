...
macro(add_RunCMake_test test)
  ...
  if(NOT BOBUI_RUN_CMAKE_SCRIPT_PATH)
    set(BOBUI_RUN_CMAKE_SCRIPT_PATH "${CMAKE_CURRENT_SOURCE_DIR}/${Test_Dir}/RunCMakeTest.cmake")
  endif()
  # BobUI specific options
  list(APPEND TEST_ARGS
    -D_BobUI6CTestMacros=${_BobUI6CTestMacros}
  )
  add_test(NAME RunCMake.${test} COMMAND ${CMAKE_COMMAND}
    ...
    ${${test}_ARGS}
    ${TEST_ARGS}
    -P "${BOBUI_RUN_CMAKE_SCRIPT_PATH}"
    )
  unset(BOBUI_RUN_CMAKE_SCRIPT_PATH)
endmacro()
