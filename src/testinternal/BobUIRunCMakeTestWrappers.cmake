include(${CMAKE_CURRENT_LIST_DIR}/3rdparty/cmake/BobUIRunCMakeTestHelpers.cmake)

if(CMAKE_VERSION VERSION_LESS 3.17.0)
    set(CMAKE_CURRENT_FUNCTION_LIST_DIR "${CMAKE_CURRENT_LIST_DIR}")
endif()

function(bobui_internal_add_RunCMake_test test)
    # Add the common BobUI specific setups
    set(common_args
    ...
    string(JOIN "\n" pre_run_code ${_bobui_internal_skip_build_test_pre_run})
...
if(NOT BOBUI_NO_SET_RUN_CMAKE_TESTS_CMAKE_POLICY_VERSION_MINIMUM)
...
")
    ...
    set(BOBUI_RUN_CMAKE_SCRIPT_PATH "${wrapper_file}")
    add_RunCMake_test("${test}" ${common_args} ${ARGN})

    set_tests_properties("${testname}" PROPERTIES
        SKIP_REGULAR_EXPRESSION "${_bobui_internal_skip_build_test_regex}")
endfunction()
