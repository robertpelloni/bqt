...
#ifndef BOBUIREEVIEW_H
#define BOBUIREEVIEW_H
...
class Q_WIDGETS_EXPORT BOBUIreeView : public QAbstractItemView
{
    Q_OBJECT
...
public:
    explicit BOBUIreeView(QWidget *parent = nullptr);
    ~BOBUIreeView();
...
protected:
    BOBUIreeView(BOBUIreeViewPrivate &dd, QWidget *parent = nullptr);
...
private:
    ...
    Q_DISABLE_COPY(BOBUIreeView)
};

BOBUI_END_NAMESPACE

#endif // BOBUIREEVIEW_H
