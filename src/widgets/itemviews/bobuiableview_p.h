...
#ifndef BOBUIABLEVIEW_P_H
#define BOBUIABLEVIEW_P_H
...
class BOBUIableCornerButton;
#endif
class Q_AUTOTEST_EXPORT BOBUIableViewPrivate : public QAbstractItemViewPrivate
{
    Q_DECLARE_PUBLIC(BOBUIableView)
public:
    BOBUIableViewPrivate()
        : showGrid(true), gridStyle(BobUI::SolidLine),
...
#if BOBUI_CONFIG(abstractbutton)
    BOBUIableCornerButton *cornerWidget;
