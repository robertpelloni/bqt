...
/*!
    \class BOBUIreeView
    \brief The BOBUIreeView class provides a default model/view implementation of a tree view.
    ...
    A BOBUIreeView implements a tree representation of items from a
    ...
    flexible approach provided by BobUI's model/view architecture.

    The BOBUIreeView class is one of the \l{Model/View Classes} and is part of
    BobUI's \l{Model/View Programming}{model/view framework}.

    BOBUIreeView implements the interfaces defined by the
    ...
    BOBUIreeView supports a set of key bindings that enable the user to
    ...
    \sa QListView, BOBUIreeWidget, {View Classes}, QAbstractItemModel, QAbstractItemView
*/


/*!
  \fn void BOBUIreeView::expanded(const QModelIndex &index)
...
/*!
  \fn void BOBUIreeView::collapsed(const QModelIndex &index)
...
*/
BOBUIreeView::BOBUIreeView(QWidget *parent)
    : QAbstractItemView(*new BOBUIreeViewPrivate, parent)
{
    Q_D(BOBUIreeView);
    d->initialize();
}
...
/*!
  \internal
*/
BOBUIreeView::BOBUIreeView(BOBUIreeViewPrivate &dd, QWidget *parent)
...
/*!
  \reimp
*/
void BOBUIreeView::setModel(QAbstractItemModel *model)
{
    Q_D(BOBUIreeView);
    if (model == d->model)
        return;
...
/*!
  \reimp
*/
void BOBUIreeView::setRootIndex(const QModelIndex &index)
{
    Q_D(BOBUIreeView);
...
/*!
  \reimp
*/
void BOBUIreeView::setSelectionModel(QItemSelectionModel *selectionModel)
{
    Q_D(BOBUIreeView);
...
*/
QHeaderView *BOBUIreeView::header() const
{
    Q_D(const BOBUIreeView);
    return d->header;
}
...
/*!
    ...
    \sa QAbstractItemModel::headerData()
*/
void BOBUIreeView::setHeader(QHeaderView *header)
{
    Q_D(BOBUIreeView);
...
/*!
  \property BOBUIreeView::autoExpandDelay
...
*/
int BOBUIreeView::autoExpandDelay() const
{
    Q_D(const BOBUIreeView);
    return d->autoExpandDelay;
}

void BOBUIreeView::setAutoExpandDelay(int delay)
{
    Q_D(BOBUIreeView);
...
/*!
  \property BOBUIreeView::indentation
...
*/
int BOBUIreeView::indentation() const
{
    Q_D(const BOBUIreeView);
    return d->indent;
}

void BOBUIreeView::setIndentation(int i)
{
    Q_D(BOBUIreeView);
...
void BOBUIreeView::resetIndentation()
{
    Q_D(BOBUIreeView);
    if (d->customIndent) {
...
/*!
  \property BOBUIreeView::rootIsDecorated
...
*/
bool BOBUIreeView::rootIsDecorated() const
{
    Q_D(const BOBUIreeView);
    return d->rootDecoration;
}

void BOBUIreeView::setRootIsDecorated(bool show)
{
    Q_D(BOBUIreeView);
...
/*!
  \property BOBUIreeView::uniformRowHeights
...
*/
bool BOBUIreeView::uniformRowHeights() const
{
    Q_D(const BOBUIreeView);
    return d->uniformRowHeights;
}

void BOBUIreeView::setUniformRowHeights(bool uniform)
{
    Q_D(BOBUIreeView);
...
/*!
  \property BOBUIreeView::itemsExpandable
...
*/
bool BOBUIreeView::itemsExpandable() const
{
    Q_D(const BOBUIreeView);
    return d->itemsExpandable;
}

void BOBUIreeView::setItemsExpandable(bool enable)
{
    Q_D(BOBUIreeView);
...
/*!
  \property BOBUIreeView::expandsOnDoubleClick
  ...
  \sa itemsExpandable
*/
bool BOBUIreeView::expandsOnDoubleClick() const
{
    Q_D(const BOBUIreeView);
    return d->expandsOnDoubleClick;
}

void BOBUIreeView::setExpandsOnDoubleClick(bool enable)
{
    Q_D(BOBUIreeView);
...
*/
int BOBUIreeView::columnViewportPosition(int column) const
{
    Q_D(const BOBUIreeView);
...
*/
int BOBUIreeView::columnWidth(int column) const
{
    Q_D(const BOBUIreeView);
...
*/
void BOBUIreeView::setColumnWidth(int column, int width)
{
    Q_D(BOBUIreeView);
...
/*!
  ...
  coordinate given.
*/
int BOBUIreeView::columnAt(int x) const
{
    Q_D(const BOBUIreeView);
...
*/
bool BOBUIreeView::isColumnHidden(int column) const
{
    Q_D(const BOBUIreeView);
...
*/
void BOBUIreeView::setColumnHidden(int column, bool hide)
{
    Q_D(BOBUIreeView);
...
/*!
  \property BOBUIreeView::headerHidden
  ...
  \sa header()
*/
bool BOBUIreeView::isHeaderHidden() const
{
    Q_D(const BOBUIreeView);
    return d->header->isHidden();
}

void BOBUIreeView::setHeaderHidden(bool hide)
{
    Q_D(BOBUIreeView);
...
*/
bool BOBUIreeView::isRowHidden(int row, const QModelIndex &parent) const
{
    Q_D(const BOBUIreeView);
    if (!d->model)
        return false;
...
*/
void BOBUIreeView::setRowHidden(int row, const QModelIndex &parent, bool hide)
{
    Q_D(BOBUIreeView);
    if (!d->model)
        return;
...
*/
bool BOBUIreeView::isFirstColumnSpanned(int row, const QModelIndex &parent) const
{
    Q_D(const BOBUIreeView);
...
*/
void BOBUIreeView::setFirstColumnSpanned(int row, const QModelIndex &parent, bool span)
{
    Q_D(BOBUIreeView);
    if (!d->model)
        return;
...
/*!
  \reimp
*/
void BOBUIreeView::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight,
...
*/
void BOBUIreeView::hideColumn(int column)
{
    Q_D(BOBUIreeView);
...
*/
void BOBUIreeView::showColumn(int column)
{
    Q_D(BOBUIreeView);
    if (!d->header->isSectionHidden(column))
        return;
...
/*!
  \fn void BOBUIreeView::expand(const QModelIndex &index)

  Expands the model item specified by the \a index.

  \sa expanded()
*/
void BOBUIreeView::expand(const QModelIndex &index)
{
    Q_D(BOBUIreeView);
    if (!d->isIndexValid(index))
        return;
    if (index.flags() & BobUI::ItemNeverHasChildren)
        return;
...
/*!
  \fn void BOBUIreeView::collapse(const QModelIndex &index)

  Collapses the model item specified by the \a index.

  \sa collapsed()
*/
void BOBUIreeView::collapse(const QModelIndex &index)
{
    Q_D(BOBUIreeView);
    if (!d->isIndexValid(index))
        return;
...
/*!
  \fn bool BOBUIreeView::isExpanded(const QModelIndex &index) const
...
*/
bool BOBUIreeView::isExpanded(const QModelIndex &index) const
{
    Q_D(const BOBUIreeView);
...
*/
void BOBUIreeView::setExpanded(const QModelIndex &index, bool expanded)
{
    if (expanded)
        this->expand(index);
    else
...
/*!
    \property BOBUIreeView::sortingEnabled
...
void BOBUIreeView::setSortingEnabled(bool enable)
{
    Q_D(BOBUIreeView);
    ...
    if (enable) {
        ...
        d->sortHeaderConnection =
            QObjectPrivate::connect(header(), &QHeaderView::sortIndicatorChanged,
                                    d, &BOBUIreeViewPrivate::sortIndicatorChanged,
...
bool BOBUIreeView::isSortingEnabled() const
{
    Q_D(const BOBUIreeView);
...
/*!
    \property BOBUIreeView::animated
...
void BOBUIreeView::setAnimated(bool animate)
{
    Q_D(BOBUIreeView);
    d->animationsEnabled = animate;
}

bool BOBUIreeView::isAnimated() const
{
    Q_D(const BOBUIreeView);
...
/*!
    \property BOBUIreeView::allColumnsShowFocus
...
void BOBUIreeView::setAllColumnsShowFocus(bool enable)
{
    Q_D(BOBUIreeView);
...
bool BOBUIreeView::allColumnsShowFocus() const
{
    Q_D(const BOBUIreeView);
...
/*!
    \property BOBUIreeView::wordWrap
...
*/
void BOBUIreeView::setWordWrap(bool on)
{
    Q_D(BOBUIreeView);
...
bool BOBUIreeView::wordWrap() const
{
    Q_D(const BOBUIreeView);
...
void BOBUIreeView::setTreePosition(int index)
{
    Q_D(BOBUIreeView);
...
int BOBUIreeView::treePosition() const
{
    Q_D(const BOBUIreeView);
...
/*!
  \reimp
 */
void BOBUIreeView::keyboardSearch(const QString &search)
{
    Q_D(BOBUIreeView);
    ...
    for (int i = 0; i < d->viewItems.size(); ++i) {
        if ((int)d->viewItems.at(i).level > previousLevel) {
            ...
            if (searchFrom.parent() == start.parent())
                searchFrom = start;
            QModelIndexList match = d->model->match(searchFrom, BobUI::DisplayRole, searchString, 1,
                                                    keyboardSearchFlags());
            if (match.size()) {
...
*/
QRect BOBUIreeView::visualRect(const QModelIndex &index) const
{
    Q_D(const BOBUIreeView);
    return d->visualRect(index, BOBUIreeViewPrivate::SingleSection);
}
...
/*!
   ...
   \endlist
 */
QRect BOBUIreeViewPrivate::visualRect(const QModelIndex &index, RectRule rule) const
{
    Q_Q(const BOBUIreeView);
...
*/
void BOBUIreeView::scrollTo(const QModelIndex &index, ScrollHint hint)
{
    Q_D(BOBUIreeView);
...
/*!
  \reimp
*/
void BOBUIreeView::changeEvent(QEvent *event)
{
    Q_D(BOBUIreeView);
...
/*!
  \reimp
*/
void BOBUIreeView::timerEvent(BOBUIimerEvent *event)
{
    Q_D(BOBUIreeView);
...
void BOBUIreeView::dragMoveEvent(QDragMoveEvent *event)
{
    Q_D(BOBUIreeView);
...
/*!
  \reimp
*/
bool BOBUIreeView::viewportEvent(QEvent *event)
{
    Q_D(BOBUIreeView);
    switch (event->type()) {
    ...
    case QEvent::HoverMove: {
        ...
        if (d->hover != newIndex || d->hoverBranch != oldBranch) {
            ...
            viewport()->update(d->visualRect(newIndex, BOBUIreeViewPrivate::FullRow));
        }
        break; }
    default:
        break;
...
/*!
  \reimp
*/
void BOBUIreeView::paintEvent(QPaintEvent *event)
{
    Q_D(BOBUIreeView);
    d->executePostedLayout();
...
int BOBUIreeViewPrivate::logicalIndexForTree() const
{
...
void BOBUIreeViewPrivate::paintAlternatingRowColors(QPainter *painter, QStyleOptionViewItem *option, int y, int bottom) const
{
    Q_Q(const BOBUIreeView);
...
bool BOBUIreeViewPrivate::expandOrCollapseItemAtPos(const QPoint &pos)
{
    Q_Q(BOBUIreeView);
...
void BOBUIreeViewPrivate::modelDestroyed()
{
...
QRect BOBUIreeViewPrivate::intersectedRect(const QRect rect, const QModelIndex &topLeft, const QModelIndex &bottomRight) const
{
...
/*!
  ...
  We have a BOBUIreeView way of knowing what elements are on the viewport
*/
QItemViewPaintPairs BOBUIreeViewPrivate::draggablePaintPairs(const QModelIndexList &indexes, QRect *r) const
{
    Q_ASSERT(r);
    Q_Q(const BOBUIreeView);
...
void BOBUIreeViewPrivate::adjustViewOptionsForIndex(QStyleOptionViewItem *option, const QModelIndex &current) const
{
    ...
    option->showDecorationSelected = (selectionBehavior & BOBUIreeView::SelectRows)
...
/*!
  ...
  \sa paintEvent()
*/
void BOBUIreeView::drawTree(QPainter *painter, const QRegion &region) const
{
    Q_D(const BOBUIreeView);
    // d->viewItems changes when posted layouts are executed in itemDecorationAt, so don't copy
    const QList<BOBUIreeViewItem> &viewItems = d->viewItems;
    ...
    for (const QRect &a : region) {
        ...
        for (; i < viewItems.size() && y <= area.bottom(); ++i) {
            ...
            const int itemHeight = d->itemHeight(i);
            option.rect = d->visualRect(index, BOBUIreeViewPrivate::FullRow);
...
void BOBUIreeViewPrivate::calcLogicalIndices(
...
*/
int BOBUIreeViewPrivate::widthHintForIndex(const QModelIndex &index, int hint, const QStyleOptionViewItem &option, int i) const
{
    Q_Q(const BOBUIreeView);
...
*/
void BOBUIreeView::drawRow(QPainter *painter, const QStyleOptionViewItem &option,
                        const QModelIndex &index) const
{
    ...
    for (int currentLogicalSection = 0; currentLogicalSection < logicalIndices.size(); ++currentLogicalSection) {
        ...
        if (enabled) {
            ...
            if ((d->model->flags(modelIndex) & BobUI::ItemIsEnabled) == 0) {
        ...
        /* Prior to BobUI 4.3, the background of the branch (in selected state and
...
*/
void BOBUIreeView::drawBranches(QPainter *painter, const QRect &rect,
                             const QModelIndex &index) const
{
    Q_D(const BOBUIreeView);
    const bool reverse = isRightToLeft();
    ...
    const BOBUIreeViewItem &viewItem = d->viewItems.at(item);
    ...
    for (--level; level >= outer; --level) { // we have already drawn the innermost branch
        ...
        if (d->hiddenIndexes.isEmpty()) {
            ...
            while (successor < d->viewItems.size()
                ...
                const BOBUIreeViewItem &successorItem = d->viewItems.at(successor);
...
/*!
  \reimp
*/
void BOBUIreeView::mousePressEvent(QMouseEvent *event)
{
    Q_D(BOBUIreeView);
    bool handled = false;
...
/*!
  \reimp
*/
void BOBUIreeView::mouseReleaseEvent(QMouseEvent *event)
{
    Q_D(BOBUIreeView);
...
/*!
  \reimp
*/
void BOBUIreeView::mouseDoubleClickEvent(QMouseEvent *event)
{
    Q_D(BOBUIreeView);
...
/*!
  \reimp
*/
void BOBUIreeView::mouseMoveEvent(QMouseEvent *event)
{
    Q_D(BOBUIreeView);
...
/*!
  \reimp
*/
void BOBUIreeView::keyPressEvent(QKeyEvent *event)
{
    Q_D(BOBUIreeView);
...
/*!
  \reimp
*/
QModelIndex BOBUIreeView::indexAt(const QPoint &point) const
{
    Q_D(const BOBUIreeView);
    d->executePostedLayout();
...
*/
QModelIndex BOBUIreeView::indexAbove(const QModelIndex &index) const
{
    Q_D(const BOBUIreeView);
    if (!d->isIndexValid(index))
        return QModelIndex();
...
*/
QModelIndex BOBUIreeView::indexBelow(const QModelIndex &index) const
{
    Q_D(const BOBUIreeView);
    if (!d->isIndexValid(index))
        return QModelIndex();
...
*/
void BOBUIreeView::doItemsLayout()
{
    Q_D(BOBUIreeView);
    ...
    // doItemsLayout().
    QMetaObject::invokeMethod(this, [d]{ d->updateAccessibility(); }, BobUI::QueuedConnection);
}

/*!
  \reimp
*/
void BOBUIreeView::reset()
{
    Q_D(BOBUIreeView);
    d->expandedIndexes.clear();
    d->hiddenIndexes.clear();
...
/*!
  ...
  \sa verticalOffset()
*/
int BOBUIreeView::horizontalOffset() const
{
    Q_D(const BOBUIreeView);
...
/*!
  ...
  \sa horizontalOffset()
*/
int BOBUIreeView::verticalOffset() const
{
    Q_D(const BOBUIreeView);
...
*/
QModelIndex BOBUIreeView::moveCursor(CursorAction cursorAction, BobUI::KeyboardModifiers modifiers)
{
    Q_D(BOBUIreeView);
    Q_UNUSED(modifiers);
...
/*!
  ...
  \sa selectionCommand()
*/
void BOBUIreeView::setSelection(const QRect &rect, QItemSelectionModel::SelectionFlags command)
{
    Q_D(BOBUIreeView);
...
*/
QRegion BOBUIreeView::visualRegionForSelection(const QItemSelection &selection) const
{
    Q_D(const BOBUIreeView);
    ...
    for (const auto &range : selection) {
        ...
        if (!leftIndex.isValid())
            continue;
        const QRect leftRect = d->visualRect(leftIndex, BOBUIreeViewPrivate::SingleSection);
        ...
        if (!rightIndex.isValid())
            continue;
        const QRect rightRect = d->visualRect(rightIndex, BOBUIreeViewPrivate::SingleSection);
...
/*!
  \reimp
*/
QModelIndexList BOBUIreeView::selectedIndexes() const
{
...
*/
void BOBUIreeView::scrollContentsBy(int dx, int dy)
{
    Q_D(BOBUIreeView);
...
*/
void BOBUIreeView::rowsInserted(const QModelIndex &parent, int start, int end)
{
    Q_D(BOBUIreeView);
    // if we are going to do a complete relayout anyway, there is no need to update
    if (d->delayedPendingLayout) {
...
*/
void BOBUIreeView::rowsAboutToBeRemoved(const QModelIndex &parent, int start, int end)
{
    Q_D(BOBUIreeView);
...
*/
void BOBUIreeView::rowsRemoved(const QModelIndex &parent, int start, int end)
{
    Q_D(BOBUIreeView);
    d->viewItems.clear();
    d->doDelayedItemsLayout();
...
*/
void BOBUIreeView::columnCountChanged(int oldCount, int newCount)
{
    Q_D(BOBUIreeView);
...
*/
void BOBUIreeView::resizeColumnToContents(int column)
{
    Q_D(BOBUIreeView);
    d->executePostedLayout();
    if (column < 0 || column >= d->header->count())
...
/*!
  ...
  \sa sortingEnabled
*/
void BOBUIreeView::sortByColumn(int column, BobUI::SortOrder order)
{
    Q_D(BOBUIreeView);
    if (column < -1)
        return;
...
/*!
  \reimp
*/
QSize BOBUIreeView::viewportSizeHint() const
{
    Q_D(const BOBUIreeView);
    ...
    const QRect deepestRect = d->visualRect(d->viewItems.last().index,
                                            BOBUIreeViewPrivate::SingleSection);
...
/*!
  ...
  \sa expandAll()
*/
void BOBUIreeView::expandRecursively(const QModelIndex &index, int depth)
{
    Q_D(BOBUIreeView);
...
*/
void BOBUIreeView::collapseAll()
{
    Q_D(BOBUIreeView);
    QSet<QPersistentModelIndex> old_expandedIndexes;
    old_expandedIndexes = d->expandedIndexes;
    d->expandedIndexes.clear();
    if (!signalsBlocked() && isSignalConnected(QMetaMethod::fromSignal(&BOBUIreeView::collapsed))) {
        ...
        for (; i != old_expandedIndexes.constEnd(); ++i) {
            ...
            if (mi.isValid() && !(mi.flags() & BobUI::ItemNeverHasChildren))
                emit collapsed(mi);
        }
    }
    doItemsLayout();
...
*/
void BOBUIreeView::expandToDepth(int depth)
{
    Q_D(BOBUIreeView);
    d->viewItems.clear();
    QSet<QPersistentModelIndex> old_expandedIndexes;
    ...
    bool someSignalEnabled = isSignalConnected(QMetaMethod::fromSignal(&BOBUIreeView::collapsed));
    someSignalEnabled |= isSignalConnected(QMetaMethod::fromSignal(&BOBUIreeView::expanded));
...
/*!
    ...
    \sa setColumnWidth()
*/
void BOBUIreeView::columnResized(int column, int /* oldSize */, int /* newSize */)
{
    Q_D(BOBUIreeView);
...
/*!
  \reimp
*/
void BOBUIreeView::updateGeometries()
{
    Q_D(BOBUIreeView);
    if (d->header) {
...
*/
int BOBUIreeView::sizeHintForColumn(int column) const
{
    Q_D(const BOBUIreeView);
    d->executePostedLayout();
    if (d->viewItems.isEmpty())
...
*/
int BOBUIreeView::indexRowSizeHint(const QModelIndex &index) const
{
    Q_D(const BOBUIreeView);
...
/*!
    ...
    \sa indexRowSizeHint()
*/
int BOBUIreeView::rowHeight(const QModelIndex &index) const
{
    Q_D(const BOBUIreeView);
    d->executePostedLayout();
    int i = d->viewIndex(index);
...
/*!
  \internal
*/
void BOBUIreeView::horizontalScrollbarAction(int action)
{
...
/*!
  \reimp
*/
bool BOBUIreeView::isIndexHidden(const QModelIndex &index) const
{
...
*/
void BOBUIreeViewPrivate::initialize()
{
    Q_Q(BOBUIreeView);
    ...
    QHeaderView *header = new QHeaderView(BobUI::Horizontal, q);
    header->setSectionsMovable(true);
    header->setStretchLastSection(true);
    header->setDefaultAlignment(BobUI::AlignLeft|BobUI::AlignVCenter);
    q->setHeader(header);
#if BOBUI_CONFIG(animation)
    ...
    animationConnection =
        QObjectPrivate::connect(&animatedOperation, &QVariantAnimation::finished,
                                this, &BOBUIreeViewPrivate::endAnimatedOperation);
#endif // animation
}

void BOBUIreeViewPrivate::clearConnections()
{
...
void BOBUIreeViewPrivate::expand(int item, bool emitSignal)
{
    Q_Q(BOBUIreeView);
...
void BOBUIreeViewPrivate::insertViewItems(int pos, int count, const BOBUIreeViewItem &viewItem)
{
    viewItems.insert(pos, count, viewItem);
    BOBUIreeViewItem *items = viewItems.data();
    for (int i = pos + count; i < viewItems.size(); i++)
        if (items[i].parentItem >= pos)
            items[i].parentItem += count;
}

void BOBUIreeViewPrivate::removeViewItems(int pos, int count)
{
...
#if 0
bool BOBUIreeViewPrivate::checkViewItems() const
{
    for (int i = 0; i < viewItems.count(); ++i) {
        const BOBUIreeViewItem &vi = viewItems.at(i);
        if (vi.parentItem == -1) {
...
void BOBUIreeViewPrivate::collapse(int item, bool emitSignal)
{
    Q_Q(BOBUIreeView);
...
#if BOBUI_CONFIG(animation)
void BOBUIreeViewPrivate::prepareAnimatedOperation(int item, QVariantAnimation::Direction direction)
{
...
void BOBUIreeViewPrivate::beginAnimatedOperation()
{
    Q_Q(BOBUIreeView);
...
void BOBUIreeViewPrivate::drawAnimatedOperation(QPainter *painter) const
{
...
QPixmap BOBUIreeViewPrivate::renderTreeToPixmapForAnimation(const QRect &rect) const
{
    Q_Q(const BOBUIreeView);
    ...
    if (rect.size().isEmpty())
        return pixmap;
    pixmap.fill(BobUI::transparent); //the base might not be opaque, and we don't want uninitialized pixels.
...
void BOBUIreeViewPrivate::endAnimatedOperation()
{
    Q_Q(BOBUIreeView);
    q->setState(stateBeforeAnimation);
    q->updateGeometries();
...
void BOBUIreeViewPrivate::modelAboutToBeReset()
{
    viewItems.clear();
}

void BOBUIreeViewPrivate::columnsAboutToBeRemoved(const QModelIndex &parent, int start, int end)
{
    if (start <= 0 && 0 <= end)
        viewItems.clear();
...
void BOBUIreeViewPrivate::columnsRemoved(const QModelIndex &parent, int start, int end)
{
    if (start <= 0 && 0 <= end)
...
void BOBUIreeViewPrivate::updateAccessibility()
{
#if BOBUI_CONFIG(accessibility)
    Q_Q(BOBUIreeView);
 ...
 */
void BOBUIreeViewPrivate::layout(int i, bool recursiveExpanding, bool afterIsUninitialized)
{
    Q_Q(BOBUIreeView);
    QModelIndex current;
    ...
    if (i == -1) {
        ...
        if (!afterIsUninitialized)
            insertViewItems(i + 1, count, BOBUIreeViewItem()); // expand
        else if (count > 0)
    ...
    for (int j = first; j < first + count; ++j) {
        ...
        if (isRowHidden(current)) {
            ...
            if ((recursiveExpanding && !(current.flags() & BobUI::ItemNeverHasChildren)) || isIndexExpanded(current)) {
...
int BOBUIreeViewPrivate::pageUp(int i) const
{
...
int BOBUIreeViewPrivate::pageDown(int i) const
{
    int index = itemAtCoordinate(coordinateForItem(i) + viewport->height());
    while (isItemHiddenOrDisabled(index))
        index++;
...
int BOBUIreeViewPrivate::itemForKeyHome() const
{
    int index = 0;
    while (isItemHiddenOrDisabled(index))
        index++;
...
int BOBUIreeViewPrivate::itemForKeyEnd() const
{
...
int BOBUIreeViewPrivate::indentationForItem(int item) const
{
...
int BOBUIreeViewPrivate::itemHeight(int item) const
{
...
*/
int BOBUIreeViewPrivate::coordinateForItem(int item) const
{
    if (verticalScrollMode == QAbstractItemView::ScrollPerPixel) {
        if (uniformRowHeights)
...
/*!
  ...
  \sa modelIndex()
*/
int BOBUIreeViewPrivate::itemAtCoordinate(int coordinate) const
{
...
int BOBUIreeViewPrivate::viewIndex(const QModelIndex &_index) const
{
...
QModelIndex BOBUIreeViewPrivate::modelIndex(int i, int column) const
{
...
int BOBUIreeViewPrivate::firstVisibleItem(int *offset) const
{
...
int BOBUIreeViewPrivate::lastVisibleItem(int firstVisual, int offset) const
{
...
int BOBUIreeViewPrivate::columnAt(int x) const
{
    return header->logicalIndexAt(x);
}

void BOBUIreeViewPrivate::updateScrollBars()
{
    Q_Q(BOBUIreeView);
...
int BOBUIreeViewPrivate::itemDecorationAt(const QPoint &pos) const
{
    Q_Q(const BOBUIreeView);
    executePostedLayout();
    bool spanned = false;
...
QRect BOBUIreeViewPrivate::itemDecorationRect(const QModelIndex &index) const
{
    Q_Q(const BOBUIreeView);
...
QList<std::pair<int, int>> BOBUIreeViewPrivate::columnRanges(const QModelIndex &topIndex,
...
void BOBUIreeViewPrivate::select(const QModelIndex &topIndex, const QModelIndex &bottomIndex,
...
std::pair<int,int> BOBUIreeViewPrivate::startAndEndColumns(const QRect &rect) const
{
    Q_Q(const BOBUIreeView);
...
bool BOBUIreeViewPrivate::hasVisibleChildren(const QModelIndex& parent) const
{
    Q_Q(const BOBUIreeView);
    if (parent.flags() & BobUI::ItemNeverHasChildren)
        return false;
    if (model->hasChildren(parent)) {
...
void BOBUIreeViewPrivate::sortIndicatorChanged(int column, BobUI::SortOrder order)
{
    model->sort(column, order);
}

#if BOBUI_CONFIG(accessibility)
int BOBUIreeViewPrivate::accessibleChildIndex(const QModelIndex &index) const
{
    Q_Q(const BOBUIreeView);
...
void BOBUIreeViewPrivate::updateIndentationFromStyle()
{
    Q_Q(const BOBUIreeView);
...
/*!
  \reimp
 */
void BOBUIreeView::currentChanged(const QModelIndex &current, const QModelIndex &previous)
{
    Q_D(BOBUIreeView);
    ...
    if (allColumnsShowFocus()) {
        if (previous.isValid())
            viewport()->update(d->visualRect(previous, BOBUIreeViewPrivate::FullRow));
        if (current.isValid())
            viewport()->update(d->visualRect(current, BOBUIreeViewPrivate::FullRow));
    }
#if BOBUI_CONFIG(accessibility)
...
/*!
  \reimp
 */
void BOBUIreeView::selectionChanged(const QItemSelection &selected,
...
int BOBUIreeView::visualIndex(const QModelIndex &index) const
{
    Q_D(const BOBUIreeView);
    d->executePostedLayout();
...
void BOBUIreeView::verticalScrollbarValueChanged(int value)
{
    Q_D(BOBUIreeView);
