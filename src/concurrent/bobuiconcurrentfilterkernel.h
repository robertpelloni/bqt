...
public:
    ...
    FilterKernel(BOBUIhreadPool *pool, Sequence &_sequence, Keep &&_keep, Reduce &&_reduce)
...
public:
    template<typename Keep = KeepFunctor, typename Reduce = ReduceFunctor>
    FilteredReducedKernel(BOBUIhreadPool *pool, Iterator begin, Iterator end, Keep &&_keep,
...
public:
    ...
    FilteredEachKernel(BOBUIhreadPool *pool, Iterator begin, Iterator end, Keep &&_keep)
...
startFiltered(BOBUIhreadPool *pool, Iterator begin, Iterator end, KeepFunctor &&functor)
{
...
inline decltype(auto) startFiltered(BOBUIhreadPool *pool, Sequence &&sequence, KeepFunctor &&functor)
{
...
inline ThreadEngineStarter<ResultType> startFilteredReduced(BOBUIhreadPool *pool,
                                                            Sequence &&sequence,
