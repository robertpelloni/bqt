...
public:
    ReduceKernel(BOBUIhreadPool *pool, ReduceOptions _reduceOptions)
...
struct SequenceHolder2 : private BobUIPrivate::SequenceHolder<Sequence>, public Base
{
    template<typename S = Sequence, typename F1 = Functor1, typename F2 = Functor2>
    SequenceHolder2(BOBUIhreadPool *pool, S &&_sequence, F1 &&functor1, F2 &&functor2,
