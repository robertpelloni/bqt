...
package org.bobuiproject.bobui.android.networkinformation;
...
class BobUIAndroidNetworkInformation {
    private static final String LOG_TAG = "BobUIAndroidNetworkInformation";
    ...
    private static BobUINetworkInformationCallback m_callback = null;
    ...
    private static class BobUINetworkInformationCallback extends NetworkCallback {
        AndroidConnectivity previousState = null;
        Transport previousTransport = null;

        BobUINetworkInformationCallback() {
        }
    ...
    private BobUIAndroidNetworkInformation() {
    }
    ...
    static void registerReceiver(final Context context) {
        synchronized (m_lock) {
            if (m_callback == null) {
                ...
                m_callback = new BobUINetworkInformationCallback();
