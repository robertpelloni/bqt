...
#ifndef BOBUIUIOCURSOR_P_H
#define BOBUIUIOCURSOR_P_H
...
Q_DECLARE_TYPEINFO(BOBUIuioCursor, Q_RELOCATABLE_TYPE); // Q_PRIMITIVE_TYPE: not possible, m_state is = 1, not 0.

BOBUI_END_NAMESPACE

#endif // BOBUIUIOCURSOR_P_H
