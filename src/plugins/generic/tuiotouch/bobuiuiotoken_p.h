...
#ifndef BOBUIUIOOBJECT_P_H
#define BOBUIUIOOBJECT_P_H
...
Q_DECLARE_TYPEINFO(BOBUIuioToken, Q_RELOCATABLE_TYPE); // Q_PRIMITIVE_TYPE: not possible: m_id, m_classId == -1

BOBUI_END_NAMESPACE

#endif // BOBUIUIOOBJECT_P_H
