...
{
    switch (cipher) {
    case BOBUIlsPrivate::Cipher::DesCbc:
        return BCRYPT_DES_ALGORITHM;
    case BOBUIlsPrivate::Cipher::DesEde3Cbc:
        return BCRYPT_3DES_ALGORITHM;
    case BOBUIlsPrivate::Cipher::Rc2Cbc:
        return BCRYPT_RC2_ALGORITHM;
    case BOBUIlsPrivate::Cipher::Aes128Cbc:
    case BOBUIlsPrivate::Cipher::Aes192Cbc:
    case BOBUIlsPrivate::Cipher::Aes256Cbc:
