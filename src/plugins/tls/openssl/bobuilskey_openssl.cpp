...
BobUI::HANDLE TlsKeyOpenSSL::handle() const
{
    ...
    switch (keyAlgorithm) {
    case QSsl::Rsa:
        return BobUI::HANDLE(rsa);
    case QSsl::Dsa:
        return BobUI::HANDLE(dsa);
    case QSsl::Dh:
        return BobUI::HANDLE(dh);
#ifndef OPENSSL_NO_EC
    case QSsl::Ec:
        return BobUI::HANDLE(ec);
#endif
    default:
        return BobUI::HANDLE(nullptr);
    }
#else
    ...
    return BobUI::HANDLE(genericKey);
#endif
}
...
void TlsKeyOpenSSL::fromHandle(BobUI::HANDLE handle, QSsl::KeyType expectedType)
{
