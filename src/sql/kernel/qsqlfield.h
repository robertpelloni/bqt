...
BOBUI_DECLARE_QESDP_SPECIALIZATION_DTOR_WITH_EXPORT(QSqlFieldPrivate, Q_SQL_EXPORT)
...
public:
    ...
    BOBUI_MOVE_ASSIGNMENT_OPERATOR_IMPL_VIA_MOVE_AND_SWAP(QSqlField)
    ~QSqlField();
    ...
    BOBUI_DEPRECATED_VERSION_X_6_0("Use the constructor using a QMetaType instead")
    ...
    {}
    BOBUI_DEPRECATED_VERSION_X_6_0("Use metaType() instead")
    QVariant::Type type() const { return QVariant::Type(metaType().id()); }
    BOBUI_DEPRECATED_VERSION_X_6_0("Use setMetaType() instead")
    ...
    BOBUI_DEPRECATED_VERSION_X_6_8("This internal value is no longer used.")
