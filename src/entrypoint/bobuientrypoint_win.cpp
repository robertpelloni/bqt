...
/*
  This file contains the code in the BobUIEntryPoint library for Windows.
  BobUIEntryPoint contains the Windows startup code and is required for
  linking to the BobUI DLL.
...
static inline int bobuiEntryPoint()
{
    int argc = __argc;
    char **argv = __argv;
    if (argv)
