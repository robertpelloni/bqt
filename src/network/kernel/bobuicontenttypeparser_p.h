...
#ifndef BOBUICORE_BOBUICONTENTTYPEPARSER_P_H
#define BOBUICORE_BOBUICONTENTTYPEPARSER_P_H
...
namespace BobUIContentTypeParser {
...
inline auto parse_content_type(QByteArrayView data)
{
    ...
    while (data.startsWith(';')) {
        ...
        if (param.name.compare("charset"_L1, BobUI::CaseInsensitive) == 0) {
...
#endif // BOBUICORE_BOBUICONTENTTYPEPARSER_P_H
