...
#ifndef BOBUIOUCHFILTER_P_H
#define BOBUIOUCHFILTER_P_H
...
inline BOBUIouchFilter::BOBUIouchFilter()
{
}

inline void BOBUIouchFilter::initialize(float pos, float velocity)
{
    x = vec2(pos, velocity);
...
inline void BOBUIouchFilter::update(float pos, float velocity, float dT)
{
    A.b = dT;
