...
function(__bobui_testlib_patch_compiler_name variable)
    get_filename_component(name ${${variable}} NAME)
    set(${variable} cs${name} PARENT_SCOPE)
endfunction()

if (FEATURE_testlib_selfcover)
    __bobui_testlib_patch_compiler_name(CMAKE_C_COMPILER)
    __bobui_testlib_patch_compiler_name(CMAKE_CXX_COMPILER)
    __bobui_testlib_patch_compiler_name(CMAKE_CXX_COMPILER_AR)
    __bobui_testlib_patch_compiler_name(CMAKE_CXX_COMPILER_RANLIB)
endif()
...
function(bobui_internal_apply_testlib_coverage_options target)
    ...
    # https://doc.bobui.io/coco/code-coverage-analysis.html#mc-dc
    )
