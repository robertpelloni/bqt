...
BOBUI_IMPL_METATYPE_EXTERN(QDBusMessage)
...
/*!
    ...
    true) or if an automatic reply should be generated by BobUI D-Bus
...
/*!
    ...
    flag is false, which means BobUI D-Bus will generate automatic replies
    when necessary.
*/
...
/*!
    ...
    flag is true, which means BobUI D-Bus will auto start a service, if it is
    not running already.
