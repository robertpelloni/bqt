...
QDBusContextPrivate *QDBusContextPrivate::set(QObject *obj, QDBusContextPrivate *newContext)
{
    ...
    void *ptr = obj->bobui_metacast("QDBusContext");
...
/*!
    ...
    {BobUI D-Bus XML compiler (qdbusxml2cpp)}.
...
/*!
    ...
    If \a enable is false, BobUI D-Bus will automatically generate a reply
    back to the caller, if needed, as soon as the called slot returns.

    If \a enable is true, BobUI D-Bus will not generate automatic
...
/*!
    ...
    from the called slot will be ignored by BobUI D-Bus.
*/
