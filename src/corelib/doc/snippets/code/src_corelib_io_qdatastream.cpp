...
void wrapInFunction()
{
    ...
    {
        int lots_of_interesting_data = 0;
        //! [3]
        QFile file("file.xxx");
        file.open(QIODevice::WriteOnly);
...
{
    int lots_of_interesting_data = 0;
    int data_new_in_XXX_version_1_2 = 0;
    int other_interesting_data = 0;
    int XXX_BAD_FILE_FORMAT = -1;
    int XXX_BAD_FILE_TOO_OLD = -2;
    int XXX_BAD_FILE_TOO_NEW = -3;
