...
#ifndef BOBUITYPETRAITS_H
#define BOBUITYPETRAITS_H
...
#if 0
#pragma bobui_class(BobUITypeTraits)
...
template <typename T>
BOBUI_DEPRECATED_VERSION_X_6_6("Use std::as_const() instead.")
...
/*
    ...
    The code tries to cover the relevant cases for BobUI and the STL, by checking (recusrsively) the value_type
...
using has_operator_equal_container = std::disjunction<std::is_base_of<Container, T>, BOBUIypeTraits::has_operator_equal<T>>;
...
template <typename Container, typename T>
using has_operator_less_than_container = std::disjunction<std::is_base_of<Container, T>, BOBUIypeTraits::has_operator_less_than<T>>;

template <typename ...T>
using compare_eq_result = std::enable_if_t<std::conjunction_v<BOBUIypeTraits::has_operator_equal<T>...>, bool>;

template <typename Container, typename ...T>
using compare_eq_result_container = std::enable_if_t<std::conjunction_v<BOBUIypeTraits::has_operator_equal_container<Container, T>...>, bool>;

template <typename ...T>
using compare_lt_result = std::enable_if_t<std::conjunction_v<BOBUIypeTraits::has_operator_less_than<T>...>, bool>;

template <typename Container, typename ...T>
using compare_lt_result_container = std::enable_if_t<std::conjunction_v<BOBUIypeTraits::has_operator_less_than_container<Container, T>...>, bool>;
...
using has_ostream_operator_container = std::disjunction<std::is_base_of<Container, T>, BOBUIypeTraits::has_ostream_operator<Stream, T>>;
...
template <typename Stream, typename Container, typename T>
using has_istream_operator_container = std::disjunction<std::is_base_of<Container, T>, BOBUIypeTraits::has_istream_operator<Stream, T>>;
