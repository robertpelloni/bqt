...
QMacTimeZonePrivate::QMacTimeZonePrivate(const QMacTimeZonePrivate &other)
    : BOBUIimeZonePrivate(other), m_nstz([other.m_nstz copy])
{
}
...
QString QMacTimeZonePrivate::displayName(BOBUIimeZone::TimeType timeType,
                                         ...
                                         const QLocale &locale) const
{
    ...
    if (nameType == BOBUIimeZone::OffsetName) {
        ...
        if (timeType == BOBUIimeZone::DaylightTime && hasDaylightTime())
    ...
    case BOBUIimeZone::ShortName :
        ...
        else if (timeType == BOBUIimeZone::GenericTime)
...
BOBUIimeZonePrivate::Data QMacTimeZonePrivate::data(qint64 forMSecsSinceEpoch) const
{
...
BOBUIimeZonePrivate::Data QMacTimeZonePrivate::nextTransition(qint64 afterMSecsSinceEpoch) const
{
    Data tran;
...
BOBUIimeZonePrivate::Data QMacTimeZonePrivate::previousTransition(qint64 beforeMSecsSinceEpoch) const
{
