...
// stable, nor we can use these APIs in builds of BobUI intended for
...
} //namespace BobUIDarwinMutex

namespace BobUIFutex = BobUIDarwinFutex;

BOBUI_END_NAMESPACE

#endif // BOBUI_CONFIG(appstore_compliant)
