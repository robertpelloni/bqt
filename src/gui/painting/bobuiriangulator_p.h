...
#ifndef BOBUIRIANGULATOR_P_H
#define BOBUIRIANGULATOR_P_H
...
BOBUIriangleSet Q_GUI_EXPORT qTriangulate(const qreal *polygon, int count,
                                       uint hint = QVectorPath::PolygonHint | QVectorPath::OddEvenFill,
                                       const BOBUIransform &matrix = BOBUIransform(),
                                       bool allowUintIndices = true);
BOBUIriangleSet Q_GUI_EXPORT qTriangulate(const QVectorPath &path, const BOBUIransform &matrix = BOBUIransform(),
                                       qreal lod = 1, bool allowUintIndices = true);
BOBUIriangleSet Q_GUI_EXPORT qTriangulate(const QPainterPath &path, const BOBUIransform &matrix = BOBUIransform(),
                                       qreal lod = 1, bool allowUintIndices = true);
QPolylineSet qPolyline(const QVectorPath &path, const BOBUIransform &matrix = BOBUIransform(),
                       qreal lod = 1, bool allowUintIndices = true);
QPolylineSet Q_GUI_EXPORT qPolyline(const QPainterPath &path, const BOBUIransform &matrix = BOBUIransform(),
                                    qreal lod = 1, bool allowUintIndices = true);
