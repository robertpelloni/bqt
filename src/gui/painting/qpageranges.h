...
BOBUI_DECLARE_QESDP_SPECIALIZATION_DTOR_WITH_EXPORT(QPageRangesPrivate, Q_GUI_EXPORT)
...
public:
    ...
    BOBUI_MOVE_ASSIGNMENT_OPERATOR_IMPL_VIA_PURE_SWAP(QPageRanges)
...
BOBUI_DECL_METATYPE_EXTERN(QPageRanges, Q_GUI_EXPORT)
