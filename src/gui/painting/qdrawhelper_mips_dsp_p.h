...
#if defined(BOBUI_COMPILER_SUPPORTS_MIPS_DSP)

extern "C" void bobui_memfill32_asm_mips_dsp(quint32 *dest, quint32 value, qsizetype count);
...
extern "C" void bobui_blend_argb32_on_argb32_mips_dsp_asm_x2(uint *dest, const uint *src, int length, uint const_alpha);

extern "C" void bobui_blend_argb32_on_argb32_const_alpha_256_mips_dsp_asm(uint *dest, const uint *src, int length);

extern "C" void bobui_blend_rgb16_on_rgb16_const_alpha_256_mips_dsp_asm(quint16 *dest, const quint16 *src, int length);

extern "C" void bobui_blend_rgb16_on_rgb16_mips_dsp_asm(quint16 *dest, const quint16 *src, int length, uint const_alpha);

extern "C" uint * destfetchARGB32_asm_mips_dsp(uint *buffer, const uint *data, int length);

extern "C" uint * bobui_destStoreARGB32_asm_mips_dsp(uint *buffer, const uint *data, int length);
...
void BOBUI_FASTCALL comp_func_solid_Source_mips_dsp(uint *dest, int length, uint color, uint const_alpha);
...
const uint * BOBUI_FASTCALL bobui_fetchUntransformed_888_mips_dsp (uint *buffer,
                                                             const Operator *,
                                                             const QSpanData *data,
                                                             int y, int x, int length);

const uint * BOBUI_FASTCALL bobui_fetchUntransformed_444_mips_dsp (uint *buffer,
                                                             const Operator *,
                                                             const QSpanData *data,
                                                             int y, int x, int length);

const uint * BOBUI_FASTCALL bobui_fetchUntransformed_argb8565_premultiplied_mips_dsp (uint *buffer,
                                                                                const Operator *,
                                                                                const QSpanData *data,
                                                                                int y, int x, int length);
...
extern "C" void bobui_blend_rgb16_on_rgb16_mips_dspr2_asm(quint16 *dest, const quint16 *src, int length, uint const_alpha);
...
#endif // BOBUI_COMPILER_SUPPORTS_MIPS_DSP
