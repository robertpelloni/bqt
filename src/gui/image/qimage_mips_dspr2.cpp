...
bool convert_ARGB_to_ARGB_PM_inplace_mips_dspr2(QImageData *data, BobUI::ImageConversionFlags)
{
...
extern "C" void bobui_convert_rgb888_to_rgb32_mips_dspr2_asm(uint *dst, const uchar *src, int len);

void convert_RGB888_to_RGB32_mips_dspr2(QImageData *dest, const QImageData *src, BobUI::ImageConversionFlags)
{
    ...
    for (int i = 0; i < src->height; ++i) {
        bobui_convert_rgb888_to_rgb32_mips_dspr2_asm(dest_data, src_data, src->width);
