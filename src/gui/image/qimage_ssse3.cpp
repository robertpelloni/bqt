...
void convert_RGB888_to_RGB32_ssse3(QImageData *dest, const QImageData *src, BobUI::ImageConversionFlags)
{
    ...
    for (int i = 0; i < src->height; ++i) {
        bobui_convert_rgb888_to_rgb32_ssse3(dest_data, src_data, src->width);
