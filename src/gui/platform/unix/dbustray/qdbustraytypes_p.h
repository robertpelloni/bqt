...
BOBUI_DECL_METATYPE_EXTERN(QXdgDBusImageStruct, Q_GUI_EXPORT)
BOBUI_DECL_METATYPE_EXTERN(QXdgDBusImageVector, Q_GUI_EXPORT)
BOBUI_DECL_METATYPE_EXTERN(QXdgDBusToolTipStruct, Q_GUI_EXPORT)
