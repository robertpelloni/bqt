...
/*!
    ...
    which causes the buffered native event queue to be flushed to BobUI's
...
/*!
    ...
    returns to the main event loop these events will be flushed to BobUI's
